...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:wi,depthTest:!1,depthWrite:!1})}function Jh(){return new Ni({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:tc(),fragmentShader:`
		...
		`,blending:wi,depthTest:!1,depthWrite:!1})}function Qh(){return new Ni({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:tc(),fragmentShader:`
		...
		`,blending:wi,depthTest:!1,depthWrite:!1})}function tc(){return`
...
#define LOW_PRECISION`),e}function Xv(s){let e="SHADOWMAP_TYPE_BASIC";return s.shadowMapType===Ad?e="SHADOWMAP_TYPE_PCF":s.shadowMapType===Cd?e="SHADOWMAP_TYPE_PCF_SOFT":s.shadowMapType===ri&&(e="SHADOWMAP_TYPE_VSM"),e}function qv(s){let e="ENVMAP_TYPE_CUBE";if(s.envMap)switch(s.envMapMode){case Ws:case js:e="ENVMAP_TYPE_CUBE";break;case ia:e="ENVMAP_TYPE_CUBE_UV";break}return e}function $v(s){let e="ENVMAP_MODE_REFLECTION";if(s.envMap)switch(s.envMapMode){case js:e="ENVMAP_MODE_REFRACTION";break}return e}function Yv(s){let e="ENVMAP_BLENDING_NONE";if(s.envMap)switch(s.combine){case na:e="ENVMAP_BLENDING_MULTIPLY";break;case Cp:e="ENVMAP_BLENDING_MIX";break;case Rp:e="ENVMAP_BLENDING_ADD";break}return e}function Kv(s){const e=s.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),112)),texelHeight:n,maxMip:t}}function Zv(s,e,t,n){const i=s.getContext(),r=t.defines;let o=t.vertexShader,a=t.fragmentShader;const l=Xv(t),c=qv(t),h=$v(t),u=Yv(t),d=Kv(t),f=kv(t),g=Bv(r),_=i.createProgram();let p,m,T=t.glslVersion?"#version "+t.glslVersion+`
...
`)}function Zb(s){const e=s.getAttribute("position"),t=s.getIndex(),n=[];for(let l=0;l<e.count;l++)n.push([e.getX(l),e.getY(l),e.getZ(l)]);const i=[];if(t)for(let l=0;l<t.count;l+=3)i.push([t.getX(l),t.getX(l+1),t.getX(l+2)]);else for(let l=0;l<e.count;l+=3)i.push([l,l+1,l+2]);const r=new ArrayBuffer(84+i.length*50),o=new DataView(r);o.setUint32(80,i.length,!0);let a=84;for(const[l,c,h]of i){const u=n[l],d=n[c],f=n[h],g=d[0]-u[0],_=d[1]-u[1],p=d[2]-u[2],m=f[0]-u[0],T=f[1]-u[1],b=f[2]-u[2],E=_*b-p*T,I=p*m-g*b,P=g*T-_*m,C=Math.sqrt(E*E+I*I+P*P)||1;o.setFloat32(a,E/C,!0),a+=4,o.setFloat32(a,I/C,!0),a+=4,o.setFloat32(a,P/C,!0),a+=4;for(const D of[u,d,f])o.setFloat32(a,D[0],!0),a+=4,o.setFloat32(a,D[1],!0),a+=4,o.setFloat32(a,D[2],!0),a+=4;o.setUint16(a,0,!0),a+=2}return r}const Zi={thickness:.003,bodyHalfWidth:.062,rearHalfWidth:.095};function xl(s){const e=Math.max(.001,Math.min(.01,s.thickness)),t=Math.max(.04,Math.min(.09,s.bodyHalfWidth)),n=Math.max(t+.01,Math.min(.13,s.rearHalfWidth)),i=.115,r=.01,o=.08,a=-.145,l=t;function c(T,b,E,I,P=8e-4){const C=new wr;return C.moveTo(T-E/2+P,b-I/2),C.lineTo(T+E/2-P,b-I/2),C.quadraticCurveTo(T+E/2,b-I/2,T+E/2,b-I/2+P),C.lineTo(T+E/2,b+I/2-P),C.quadraticCurveTo(T+E/2,b+I/2,T+E/2-P,b+I/2),C.lineTo(T-E/2+P,b+I/2),C.quadraticCurveTo(T-E/2,b+I/2,T-E/2,b+I/2-P),C.lineTo(T-E/2,b-I/2+P),C.quadraticCurveTo(T-E/2,b-I/2,T-E/2+P,b-I/2),C}function h(T,b,E){const I=new wr;return I.absarc(T,b,E,0,Math.PI*2,!1),I}const u=new df;u.moveTo(-n+r,i),u.lineTo(n-r,i),u.quadraticCurveTo(n,i,n,i-r),u.lineTo(n,o),u.lineTo(t,o),u.lineTo(t,a+l),u.absarc(0,a+l,t,0,-Math.PI,!0),u.lineTo(-t,o),u.lineTo(-n,o),u.lineTo(-n,i-r),u.quadraticCurveTo(-n,i,-n+r,i);const d=n-.02;u.holes.push(c(-d,.093,.012,.014,.001)),u.holes.push(c(d,.093,.012,.014,.001));const f=new wr,g=0,_=.05;f.moveTo(g-.025,_-.035),f.lineTo(g-.025,_-.018),f.lineTo(g-.033,_-.018),f.lineTo(g-.033,_+.002),f.lineTo(g-.025,_+.002),f.lineTo(g-.025,_+.018),f.lineTo(g-.015,_+.028),f.lineTo(g+.015,_+.028),f.lineTo(g+.025,_+.018),f.lineTo(g+.025,_+.002),f.lineTo(g+.033,_+.002),f.lineTo(g+.033,_-.018),f.lineTo(g+.025,_-.018),f.lineTo(g+.025,_-.035),f.lineTo(g-.025,_-.035),u.holes.push(f),u.holes.push(c(-.025,.098,.018,.006,.001)),u.holes.push(c(.025,.098,.018,.006,.001)),u.holes.push(c(0,.09,.014,.004,.001)),u.holes.push(c(-.025,-.085,.018,.004,.001)),u.holes.push(c(.025,-.085,.018,.004,.001)),u.holes.push(h(0,-.098,.006));const p=.002;u.holes.push(h(-.08,.105,p)),u.holes.push(h(.08,.105,p)),u.holes.push(h(-.08,.083,p)),u.holes.push(h(.08,.083,p)),u.holes.push(h(-.02,.108,p)),u.holes.push(h(.02,.108,p)),u.holes.push(h(-.048,.01,p)),u.holes.push(h(.048,.01,p)),u.holes.push(h(-.048,-.03,p)),u.holes.push(h(.048,-.03,p)),u.holes.push(h(0,-.02,p)),u.holes.push(h(-.014,-.065,p)),u.holes.push(h(.014,-.065,p)),u.holes.push(h(-.014,-.052,p)),u.holes.push(h(.014,-.052,p)),u.holes.push(h(-.04,-.062,p)),u.holes.push(h(.04,-.062,p));const m=new cc(u,{depth:e,bevelEnabled:!1,curveSegments:48});return m.rotateZ(-Math.PI/2),Zb(m)}const Ki={radius:.0325,width:.026};function bl(s){const e=Math.max(.02,Math.min(.05,s.radius)),t=e*(31/32.5),n=Math.max(.008,Math.min(.03,s.width)),i=64,r=16,o=4,a=.58,l=.62,c=[],h=(T,b,E)=>c.push(...T,...b,...E),u=(T,b,E,I)=>{h(T,b,E),h(T,E,I)};for(let T=0;T<i;T++){const b=2*Math.PI*T/i,E=2*Math.PI*(T+1)/i,I=Math.cos(b),P=Math.sin(b),C=Math.cos(E),D=Math.sin(E),M=[t*I,t*P,-n/2],v=[t*C,t*D,-n/2],U=[t*I,t*P,n/2],z=[t*C,t*D,n/2];u(M,v,z,U),h([0,0,-n/2],v,M),h([0,0,n/2],U,z)}const d=2*Math.PI/r,f=n/o;for(let T=0;T<r;T++){const b=d*(T+.5),E=b-d*a/2,I=b+d*a/2;for(let P=0;P<o;P++){const C=-n/2+f*(P+.5),D=C-f*l/2,M=C+f*l/2,[v,U,z,F]=[Math.cos(E),Math.sin(E),Math.cos(I),Math.sin(I)],H=[t*v,t*U,D],J=[t*z,t*F,D],B=[t*v,t*U,M],ce=[t*z,t*F,M],G=[e*v,e*U,D],ie=[e*z,e*F,D],oe=[e*v,e*U,M],pe=[e*z,e*F,M];u(G,ie,pe,oe),u(H,G,oe,B),u(J,ce,pe,ie),u(H,J,ie,G),u(oe,pe,ce,B)}}const g=c.length/9,_=new ArrayBuffer(84+g*50),p=new DataView(_);p.setUint32(80,g,!0);let m=84;for(let T=0;T<g;T++){const b=T*9,E=c[b+3]-c[b],I=c[b+4]-c[b+1],P=c[b+5]-c[b+2],C=c[b+6]-c[b],D=c[b+7]-c[b+1],M=c[b+8]-c[b+2],v=I*M-P*D,U=P*C-E*M,z=E*D-I*C,F=Math.sqrt(v*v+U*U+z*z)||1;p.setFloat32(m,v/F,!0),m+=4,p.setFloat32(m,U/F,!0),m+=4,p.setFloat32(m,z/F,!0),m+=4;for(let H=0;H<9;H++)p.setFloat32(m,c[b+H],!0),m+=4;p.setUint16(m,0,!0),m+=2}return _}const Ti=[{id:"hcsr04",label:"HC-SR04",category:"Sensor",description:"Ultrasonic distance sensor",defaultDims:[.045,.02,.015],cssColor:"#3373e5",urdfRgba:"0.20 0.45 0.90 1.00",defaultZ:.015,factory:()=>oi(()=>import("./generators-BbA6EJaH.js"),[]).then(s=>({generate:s.generateHcsr04}))},{id:"l298n",label:"L298N",category:"Actuator",description:"Dual H-bridge motor driver",defaultDims:[.043,.043,.02],cssColor:"#c01f1f",urdfRgba:"0.75 0.12 0.12 1.00",defaultZ:.005,factory:()=>oi(()=>import("./generators-BbA6EJaH.js"),[]).then(s=>({generate:s.generateL298n}))},{id:"esp32cam_lib",label:"ESP32-CAM",category:"MCU",description:"ESP32 camera module",defaultDims:[.0405,.027,.013],cssColor:"#1a7a3c",urdfRgba:"0.00 0.45 0.20 1.00",defaultZ:.005,factory:()=>oi(()=>import("./generators-BbA6EJaH.js"),[]).then(s=>({generate:s.generateEsp32Cam}))},{id:"tt_motor",label:"TT Motor",category:"Actuator",description:"TT gear motor with DC can",defaultDims:[.036,.018,.022],cssColor:"#c89a14",urdfRgba:"0.83 0.63 0.09 1.00",defaultZ:.011,factory:()=>oi(()=>import("./generators-BbA6EJaH.js"),[]).then(s=>({generate:s.generateTtMotor}))},{id:"sg90",label:"SG90",category:"Actuator",description:"Micro servo motor",defaultDims:[.022,.0115,.023],cssColor:"#e07810",urdfRgba:"0.90 0.50 0.15 1.00",defaultZ:.012,factory:()=>oi(()=>import("./generators-BbA6EJaH.js"),[]).then(s=>({generate:s.generateSg90}))},{id:"arduino_nano",label:"Arduino Nano",category:"MCU",description:"Arduino Nano microcontroller",defaultDims:[.043,.018,.01],cssColor:"#006e33",urdfRgba:"0.00 0.50 0.30 1.00",defaultZ:.005,factory:()=>oi(()=>import("./generators-BbA6EJaH.js"),[]).then(s=>({generate:s.generateArduinoNano}))},{id:"mpu6050",label:"MPU-6050",category:"Sensor",description:"6-axis IMU (accelerometer + gyroscope)",defaultDims:[.02,.02,.0025],cssColor:"#7a52cc",urdfRgba:"0.55 0.35 0.80 1.00",defaultZ:.005,factory:()=>oi(()=>import("./generators-BbA6EJaH.js"),[]).then(s=>({generate:s.generateMpu6050}))}],Jb=Object.fromEntries(Ti.map(s=>[s.id,{label:s.label,color:s.urdfRgba,defaultZ:s.defaultZ,geomType:"mesh",defaultDims:[...s.defaultDims],category:s.category,cssColor:s.cssColor}])),Nn={ultrasonic:{label:"Ultrasonic",color:"0.20 0.45 0.90 1.00",defaultZ:.015,geomType:"box",defaultDims:[.045,.02,.015],hidden:!0},camera:{label:"Camera",color:"0.90 0.20 0.25 1.00",defaultZ:.01,geomType:"box",defaultDims:[.025,.024,.009]},lidar:{label:"LIDAR",color:"0.20 0.80 0.45 1.00",defaultZ:.035,geomType:"cylinder",defaultDims:[.035,.04]},imu:{label:"IMU",color:"0.55 0.35 0.80 1.00",defaultZ:.008,geomType:"box",defaultDims:[.02,.02,.008],hidden:!0},servo:{label:"Servo",color:"0.90 0.50 0.15 1.00",defaultZ:.02,geomType:"box",defaultDims:[.022,.012,.03],hidden:!0},arduino:{label:"Arduino",color:"0.00 0.45 0.20 1.00",defaultZ:.008,geomType:"box",defaultDims:[.044,.018,.008],hidden:!0},raspberry_pi:{label:"Raspberry Pi",color:"0.70 0.10 0.20 1.00",defaultZ:.017,geomType:"box",defaultDims:[.086,.056,.017]},gps:{label:"GPS",color:"0.20 0.70 0.35 1.00",defaultZ:.01,geomType:"box",defaultDims:[.025,.025,.01]},buck_converter:{label:"Buck Conv.",color:"0.85 0.60 0.00 1.00",defaultZ:.011,geomType:"box",defaultDims:[.023,.017,.011]},box:{label:"Box",color:"0.65 0.65 0.65 1.00",defaultZ:.02,geomType:"box",defaultDims:[.04,.04,.02]},...Jb},Qb=new Set(["robot-car"]);function cd(s,e){const t=[...e.entries()].sort(([r],[o])=>r.localeCompare(o)),n=t.filter(([r])=>r.startsWith("00")).map(([,r])=>r.trimEnd()).join(`
...
BRIEF MODE: Answer in fewer than 4 lines. No preamble. Direct answers only. Emoji allowed as semantic shorthand when it replaces a word more efficiently than text.`:"";return`${this._guide?`GUIDE MODE: You are an interactive assembly guide. Rules:
...
Available library components: ${Ti.map(u=>u.id).join(", ")}${o}${l}
...
`}let Bo=null;async function hM(s){const e=s.parts,t=await fetch(`${e}.parts.json`).then(l=>l.json()),n=e.replace(/\/[^/]+$/,""),i=await Promise.all(t.parts.map(l=>fetch(`${n}/parts/${l}`).then(c=>c.text()))),r=new Map(t.parts.map((l,c)=>[l,i[c]]));be.init(t.robot,n,r);const o=cM(t.robot,r).replace(/filename="([^/"]+)"/g,`filename="${n}/$1"`);Bo&&URL.revokeObjectURL(Bo),Bo=URL.createObjectURL(new Blob([o],{type:"application/xml"})),Ue.urdf=Bo,ya();const a=be.restore();for(const{id:l,type:c}of a){const h=Nn[c];if((h==null?void 0:h.geomType)==="mesh"){const u=Ti.find(d=>d.id===c);u&&u.factory().then(({generate:d})=>be.restoreMeshBlob(l,d())).catch(d=>console.warn("[restore] mesh regen failed for",l,d))}ls(l,c)}a.length>0&&$r(),jn(),Hr()}const es=[{name:"Robot Car",label:"Car",parts:"/robots/robot-car/robot-car",up:"+Z"},{name:"T12",label:"T12",urdf:"/robots/T12/urdf/T12.URDF",up:"-Z"},{name:"TriATHLETE",label:"Tri",urdf:"/robots/TriATHLETE/urdf/TriATHLETE.URDF",up:"-Z"},{name:"Laikago",label:"Laikago",urdf:"/robots/laikago/urdf/laikago.urdf",up:"+Z"},{name:"Open Manipulator X",label:"OM-X",urdf:"/robots/open_manipulator_x/open_manipulator_x.urdf",package:"open_manipulator_description: /robots/open_manipulator_x",up:"+Z"},{name:"SO-ARM100",label:"SO-100",urdf:"/robots/so_arm100/so100.urdf",up:"+Z"},{name:"Simple Humanoid",label:"Humanoid",urdf:"/robots/simple_humanoid/simple_humanoid.urdf",up:"+Z"},{name:"Spryped",label:"Spryped",urdf:"/robots/spryped/urdf/spryped.urdf",package:"spryped_urdf_rev06: /robots/spryped",up:"+Z"}];let Lf=0;const Os=Te("robot-track-slider");function pa(s){const e=as.getBoundingClientRect(),t=s.getBoundingClientRect();Os.style.width=`${t.width}px`,Os.style.height=`${t.height}px`,Os.style.left=`${t.left-e.left}px`,Os.style.top=`${t.top-e.top}px`}function Rr(){const s=as.querySelector(".robot-btn.active");s&&pa(s)}function uM(){for(const s of as.querySelectorAll(".robot-btn"))s.classList.remove("active")}function zr(s,e){Lf=e,Ue.up=s.up,Qo.value=s.up,Ue.package=s.package??"";const t=s.parts?`${s.parts}.urdf`:s.urdf;s.parts?hM(s).catch(()=>{}):Ue.urdf=s.urdf,uM();const n=s.name?as.querySelector(`.robot-btn[data-name="${s.name}"]`):null;n&&(n.classList.add("active"),pa(n)),un.setSourceUrl(t),un.loadPartsInBackground()}let _n=null,_r=null;for(let s=0;s<es.length;s++){const e=es[s],t=document.createElement("button");t.type="button",t.className="robot-btn",t.textContent=e.label,t.title=e.name,t.dataset.name=e.name,t.dataset.index=String(s),t.addEventListener("click",()=>zr(e,s)),t.addEventListener("mouseenter",()=>{pa(t),_n&&clearTimeout(_n),_n=setTimeout(()=>zr(e,s),150)}),as.appendChild(t)}as.closest(".robot-shell").addEventListener("mouseleave",()=>{_n&&(clearTimeout(_n),_n=null),Rr()});new ResizeObserver(Rr).observe(as);Os.style.transition="none";zr(es[0],0);requestAnimationFrame(()=>requestAnimationFrame(()=>{Os.style.transition=""}));document.addEventListener("keydown",s=>{if(s.key!=="ArrowLeft"&&s.key!=="ArrowRight")return;const e=document.activeElement;if(e.tagName==="INPUT"||e.tagName==="TEXTAREA"||e.isContentEditable)return;const t=s.key==="ArrowRight"?1:-1,n=(Lf+t+es.length)%es.length;zr(es[n],n)});ud.addEventListener("change",()=>{Ue.ignoreLimits=ud.checked});dd.addEventListener("change",()=>{Ue.showCollision=dd.checked});Wl.addEventListener("change",()=>{Ue.displayShadow=Wl.checked});Qo.addEventListener("change",()=>{Ue.up=Qo.value});Wl.checked=Ue.displayShadow;Qo.value=Ue.up;function jl(s){return s.replace(/_joint$/,"").replace(/_/g," ").replace(/\b\w/g,e=>e.toUpperCase())}function Pf(s){return s.replace(/_joint$/,"")}const fd=Te("inspector"),dM=Te("inspector-name"),xc=Te("inspector-x"),bc=Te("inspector-y"),Mc=Te("inspector-z"),ma=Te("inspector-scale-x"),ga=Te("inspector-scale-y"),_a=Te("inspector-scale-z"),Nf=Te("inspector-snippet"),Sl=Te("inspector-copy"),fM=Te("inspector-close");let ts=null,Lr=null,ai=null;function li(s){return s.toFixed(4)}function If(){if(!ts||!Ue.robot)return;const s=Ue.robot.joints[ts];if(!s)return;const e=s.position,t=s.rotation,n=parseFloat(ma.value),i=parseFloat(ga.value),r=parseFloat(_a.value),o=Math.abs(n-1)>.005||Math.abs(i-1)>.005||Math.abs(r-1)>.005,a=Math.abs(n-i)<.001&&Math.abs(i-r)<.001;let l="";o&&a?l=`
scale: ${n.toFixed(2)}×`:o&&(l=`
scale: ${n.toFixed(2)} ${i.toFixed(2)} ${r.toFixed(2)}`),Nf.textContent=`[${ts}]
<origin xyz="${li(e.x)} ${li(e.y)} ${li(e.z)}"
        rpy="${li(t.x)} ${li(t.y)} ${li(t.z)}"/>${l}`}let pd=0;function pM(){if(!ts||!Ue.robot)return;const s=Ue.robot.joints[ts];if(!s)return;s.position.set(parseFloat(xc.value)||0,parseFloat(bc.value)||0,parseFloat(Mc.value)||0);const e=parseFloat(ma.value)||1,t=parseFloat(ga.value)||1,n=parseFloat(_a.value)||1,i=Ue.robot.links[Pf(ts)];i&&i.scale.set(e,t,n),Ue.redraw(),clearTimeout(pd),pd=window.setTimeout(If,150)}function qr(s){var i;ts=s;const e=s?(i=Ue.robot)==null?void 0:i.joints[s]:null;if(!e){fd.style.display="none",Ri&&(Ri=null,ea(null));return}fd.style.display="",dM.textContent=jl(s);const t=e.position;xc.value=li(t.x),bc.value=li(t.y),Mc.value=li(t.z);const n=Ue.robot.links[Pf(s)];if(ma.value=String(n?n.scale.x:1),ga.value=String(n?n.scale.y:1),_a.value=String(n?n.scale.z:1),If(),ai==null||ai.setSelectedJoint(s),document.body.classList.contains("build-open")){const r=s.endsWith("_joint")?s.slice(0,-6):s;if(!be.componentIds.has(r)){kt=null,Ri=s;for(const o of Kn.querySelectorAll(".build-component"))o.classList.remove("selected");Oc.hidden=!0,ea({label:jl(s),color:"var(--text-3)",onDismiss:()=>qr(null)})}}}function Df(s,e){let t=0,n=0,i=!1;const r=parseFloat(e.step)||.001;s.addEventListener("pointerdown",o=>{t=o.clientX,n=parseFloat(e.value)||0,i=!1,s.setPointerCapture(o.pointerId)}),s.addEventListener("pointermove",o=>{if(!s.hasPointerCapture(o.pointerId))return;const a=o.clientX-t;!i&&Math.abs(a)<3||(i=!0,e.value=String(parseFloat((n+a*r).toFixed(6))),e.dispatchEvent(new Event("input",{bubbles:!0})))}),s.addEventListener("pointerup",()=>{i||e.focus(),i=!1})}var wd;for(const s of[xc,bc,Mc,ma,ga,_a]){s.addEventListener("input",pM);const e=(wd=s.closest(".inspector-row"))==null?void 0:wd.querySelector("label");e&&Df(e,s)}fM.addEventListener("click",()=>qr(null));Sl.addEventListener("click",()=>{navigator.clipboard.writeText(Nf.textContent??""),Sl.textContent="Copied!",setTimeout(()=>{Sl.textContent="Copy"},1500)});Ue.addEventListener("click",()=>{Lr&&(qr(Lr),un.isOpen&&un.jumpToJoint(Lr))});const Sc=Te("urdf-error-banner"),mM=Te("urdf-error-text"),gM=Te("urdf-error-close");Ue.addEventListener("urdf-change",()=>{yc.classList.add("visible"),ss.innerHTML="",qr(null),Sc.classList.remove("visible")});Ue.addEventListener("urdf-error",s=>{yc.classList.remove("visible"),mM.textContent=s.detail||"URDF load error",Sc.classList.add("visible")});gM.addEventListener("click",()=>{Sc.classList.remove("visible")});Ue.addEventListener("urdf-processed",()=>{yc.classList.remove("visible"),document.querySelectorAll('input[data-preview="true"]').forEach(s=>{s.value="0"}),requestAnimationFrame(()=>{di.position.y=Ue.shadowPlane.position.y})});const md=Math.PI/180;let vr=null;function _M(){vr==null||vr.abort(),vr=new AbortController;const{signal:s}=vr;if(ss.innerHTML="",!Ue.robot)return;const e=Object.values(Ue.robot.joints).filter(t=>t.jointType!=="fixed"&&t.visible).sort((t,n)=>t.name.localeCompare(n.name));for(const t of e){const n=document.createElement("div");n.className="joint",n.dataset.joint=t.name;const i=document.createElement("div");i.className="joint-name",i.title=t.name,i.textContent=t.name;const r=document.createElement("div");r.className="joint-row";const o=document.createElement("input");o.type="range",o.step="0.001";const a=document.createElement("input");a.type="number",a.step="0.001";const l=t.jointType==="prismatic",c=l?1:1/md;n.update=()=>{const h=t.jointType==="continuous",u=Ue.ignoreLimits||h?-6.28:t.limit.lower,d=Ue.ignoreLimits||h?6.28:t.limit.upper;o.min=String(u),o.max=String(d),o.value=String(t.angle),a.min=String(+(u*c).toFixed(3)),a.max=String(+(d*c).toFixed(3)),a.value=String(+(t.angle*c).toPrecision(4))},o.addEventListener("input",()=>{Ue.setJointValue(t.name,parseFloat(o.value))},{signal:s}),a.addEventListener("change",()=>{const h=l?1:md;Ue.setJointValue(t.name,parseFloat(a.value)*h)},{signal:s}),r.append(o,a),n.append(i,r),ss.appendChild(n),n.update()}}Ue.addEventListener("urdf-processed",_M);Ue.addEventListener("ignore-limits-change",()=>{var s;for(const e of ss.querySelectorAll(".joint"))(s=e.update)==null||s.call(e)});Ue.addEventListener("angle-change",s=>{var t,n;const e=s.detail;(n=(t=ss.querySelector(`[data-joint="${e}"]`))==null?void 0:t.update)==null||n.call(t)});let gd=0;Ue.addEventListener("pointermove",s=>{cancelAnimationFrame(gd),gd=requestAnimationFrame(()=>{kr.style.left=s.clientX+14+"px",kr.style.top=s.clientY-32+"px"})});Ue.addEventListener("joint-mouseover",s=>{var t;const e=s.detail;Lr=e,(t=ss.querySelector(`[data-joint="${e}"]`))==null||t.setAttribute("data-hovered",""),kr.textContent=jl(e),kr.style.display="block"});Ue.addEventListener("joint-mouseout",s=>{var t;const e=s.detail;Lr=null,(t=ss.querySelector(`[data-joint="${e}"]`))==null||t.removeAttribute("data-hovered"),kr.style.display="none"});function vM(s,e){var i;const t=(i=document.elementFromPoint(s,e))==null?void 0:i.closest(".robot-btn");if(t){t.click();return}const n={clientX:s,clientY:e,bubbles:!0,pointerId:1};Ue.dispatchEvent(new PointerEvent("pointerdown",n)),Ue.dispatchEvent(new PointerEvent("pointerup",n))}Ml.addEventListener("click",async()=>{if(ai){ai.stop();return}const{GestureController:s}=await oi(async()=>{const{GestureController:e}=await import("./gesture-D-K4ek9C.js");return{GestureController:e}},[]);ai=new s({viewer:Ue,overlayCanvas:rM,videoEl:oM,onDwellSelect:vM,onPointerMove(e,t){var i;const n=(i=document.elementFromPoint(e,t))==null?void 0:i.closest(".robot-btn");if(n){if(pa(n),n!==_r){_r=n,_n&&clearTimeout(_n);const r=parseInt(n.dataset.index,10);_n=setTimeout(()=>zr(es[r],r),150)}}else _r&&(_r=null,_n&&(clearTimeout(_n),_n=null)),Rr()},onPointerLeave(){_r=null,Rr()},onStop(){ai=null,Ml.classList.remove("active"),Rr()}}),ai.start().then(()=>{Ml.classList.add("active"),Cf.classList.add("open"),Br.setAttribute("aria-expanded","true")}).catch(()=>{ai=null})});Br.addEventListener("click",()=>{const s=Cf.classList.toggle("open");Br.setAttribute("aria-expanded",String(s))});Br.addEventListener("keydown",s=>{(s.key==="Enter"||s.key===" ")&&(s.preventDefault(),Br.click())});function yM(s,e,t){s.addEventListener("input",()=>{e.value=s.value,t()}),e.addEventListener("change",()=>{const n=Math.max(parseFloat(e.min),Math.min(parseFloat(e.max),parseFloat(e.value)));s.value=String(n),e.value=String(n),t()})}const Ec=Te("build-chassis-thickness"),Tc=Te("build-chassis-body-hw"),wc=Te("build-chassis-rear-hw"),Ac=Te("build-wheel-radius"),Cc=Te("build-wheel-width"),Rc=Te("build-caster-radius"),Lc=Te("build-caster-width"),Pc=Te("build-battery-l"),Nc=Te("build-battery-w"),Ic=Te("build-battery-h"),Dc=Te("build-powerbank-r"),Uc=Te("build-powerbank-l");function El(){be.isSupported&&be.updateChassis({thickness:parseFloat(Ec.value)/1e3,bodyHalfWidth:parseFloat(Tc.value)/1e3,rearHalfWidth:parseFloat(wc.value)/1e3})}function _d(){be.isSupported&&be.updateWheel({radius:parseFloat(Ac.value)/1e3,width:parseFloat(Cc.value)/1e3})}function vd(){be.isSupported&&be.updateCaster(parseFloat(Rc.value)/1e3,parseFloat(Lc.value)/1e3)}function Tl(){be.isSupported&&be.updateBatteryBox(parseFloat(Pc.value)/1e3,parseFloat(Nc.value)/1e3,parseFloat(Ic.value)/1e3)}function yd(){be.isSupported&&be.updatePowerbank(parseFloat(Dc.value)/1e3,parseFloat(Uc.value)/1e3)}const xM=[[Ec,"build-chassis-thickness-num",Zi.thickness*1e3,El],[Tc,"build-chassis-body-hw-num",Zi.bodyHalfWidth*1e3,El],[wc,"build-chassis-rear-hw-num",Zi.rearHalfWidth*1e3,El],[Ac,"build-wheel-radius-num",Ki.radius*1e3,_d],[Cc,"build-wheel-width-num",Ki.width*1e3,_d],[Rc,"build-caster-radius-num",0,vd],[Lc,"build-caster-width-num",0,vd],[Pc,"build-battery-l-num",0,Tl],[Nc,"build-battery-w-num",0,Tl],[Ic,"build-battery-h-num",0,Tl],[Dc,"build-powerbank-r-num",0,yd],[Uc,"build-powerbank-l-num",0,yd]];for(const[s,e,t,n]of xM){t>0&&(s.value=String(t));const i=Te(e);i.value=s.value,yM(s,i,n)}const xd=Te("build-export"),zo=Te("build-copy-urdf"),Uf=Te("build-undo"),Of=Te("build-redo"),bM=Te("build-reset"),MM=Te("build-palette"),Kn=Te("build-components-list"),SM=Te("build-new-name"),EM=Te("build-new-create"),Ff=Te("build-saved-toggle"),Ji=Te("build-saved-list"),kf=Te("build-active-header"),TM=Te("build-active-name"),Bf=Te("build-clear-custom"),wM=Te("build-shortcuts-toggle"),bd=Te("build-shortcuts"),zf=Te("lib-search"),Md=Te("lib-pills"),Sd=Te("lib-grid"),AM=Te("lib-no-build"),CM=Te("lib-empty"),RM=Te("build-comp-count"),LM=Te("build-comp-empty"),wl=document.getElementById("chat-context-bar"),Oc=document.getElementById("build-inspector"),PM=document.getElementById("build-inspector-title"),Ns=document.getElementById("build-inspector-body"),NM=document.getElementById("build-inspector-close");function $r(){const s=be.chassisParams,e=be.wheelParams,t=be.powerbank,n=be.batteryBox,i=[[Ec,"build-chassis-thickness-num",s.thickness*1e3],[Tc,"build-chassis-body-hw-num",s.bodyHalfWidth*1e3],[wc,"build-chassis-rear-hw-num",s.rearHalfWidth*1e3],[Ac,"build-wheel-radius-num",e.radius*1e3],[Cc,"build-wheel-width-num",e.width*1e3],[Rc,"build-caster-radius-num",be.casterRadius*1e3],[Lc,"build-caster-width-num",be.casterWidth*1e3],[Pc,"build-battery-l-num",n.l*1e3],[Nc,"build-battery-w-num",n.w*1e3],[Ic,"build-battery-h-num",n.h*1e3],[Dc,"build-powerbank-r-num",t.radius*1e3],[Uc,"build-powerbank-l-num",t.length*1e3]];for(const[r,o,a]of i)r.value=String(a),Te(o).value=String(a);if(kt){const r=be.getComponentEntries().find(o=>o.id===kt);r&&Vf(kt,r.type)}}Uf.addEventListener("click",()=>be.undo());Of.addEventListener("click",()=>be.redo());bM.addEventListener("click",()=>{be.isCatalogActive&&(be.resetToDefaults(),$r())});be.onHistoryChange=()=>{Uf.disabled=!be.canUndo,Of.disabled=!be.canRedo};be.onDOMRebuild=()=>{var e,t;const s=kt;ya();for(const{id:n,type:i}of be.getComponentEntries())ls(n,i),((e=Nn[i])==null?void 0:e.geomType)==="mesh"&&Kf(n,i);$r(),jn(),(t=be.onHistoryChange)==null||t.call(be),Cr==null||Cr.syncToolCount(),s&&be.getComponentData(s)&&ba(s)};NM.addEventListener("click",()=>rs());document.addEventListener("keydown",s=>{if(be.isActive){if((s.ctrlKey||s.metaKey)&&s.key==="z"&&!s.shiftKey&&(s.preventDefault(),be.undo()),(s.ctrlKey||s.metaKey)&&(s.key==="y"||s.key==="z"&&s.shiftKey)&&(s.preventDefault(),be.redo()),kt&&(s.key==="Delete"||s.key==="Backspace")&&!s.ctrlKey&&!s.metaKey){const e=document.activeElement;if(e.tagName==="INPUT"||e.tagName==="TEXTAREA"||e.isContentEditable)return;s.preventDefault();const t=kt,n=Kn.querySelector(`[data-id="${t}"]`);be.removeComponent(t),rs(),Fc(t),n==null||n.remove(),jn();return}if(s.key==="Escape"&&kt){const e=document.activeElement;if(e.tagName==="INPUT"||e.tagName==="TEXTAREA")return;rs();return}if(kt&&["ArrowLeft","ArrowRight","ArrowUp","ArrowDown"].includes(s.key)&&!s.ctrlKey&&!s.metaKey){s.preventDefault();const e=be.getComponentData(kt);if(!e)return;const t=.001;let{x:n,y:i,z:r}=e;s.shiftKey?(s.key==="ArrowUp"&&(r+=t),s.key==="ArrowDown"&&(r-=t)):(s.key==="ArrowLeft"&&(i+=t),s.key==="ArrowRight"&&(i-=t),s.key==="ArrowUp"&&(n-=t),s.key==="ArrowDown"&&(n+=t)),be.updateComponent(kt,{x:n,y:i,z:r});const o=Zs.get(kt);o&&(o.x.value=n.toFixed(4),o.y.value=i.toFixed(4),o.z.value=r.toFixed(4))}}});xd.addEventListener("click",()=>void be.exportZip(xd));zo.addEventListener("click",()=>{const s=be.getURDFXML();navigator.clipboard.writeText(s).then(()=>{const e=zo.textContent;zo.textContent="Copied!",setTimeout(()=>{zo.textContent=e},1500)}).catch(()=>{})});EM.addEventListener("click",()=>{ya(),be.initFromScratch(SM.value),be.open(),Te("tab-build").click(),va(),Hr(),jn()});function va(){const s=fa.savedCustomNames();if(Ff.hidden=s.length===0,s.length===0){Ji.hidden=!0;return}Ji.innerHTML="";for(const e of s){const t=document.createElement("div");t.className="build-saved-row";const n=document.createElement("span");n.className="build-saved-name",n.textContent=e;const i=document.createElement("button");i.type="button",i.className="build-export-btn build-saved-load",i.textContent="Load",i.addEventListener("click",()=>{ya();const o=be.restoreCustomByName(e);for(const{id:a,type:l}of o)ls(a,l);o.length>0&&$r(),jn(),be.open(),Te("tab-build").click(),Hr(),Ji.hidden=!0});const r=document.createElement("button");r.type="button",r.className="build-remove-btn",r.textContent="×",r.title="Delete saved robot",r.addEventListener("click",()=>{be.deleteCustom(e),be.robotName===e&&Hr(),va()}),t.append(n,i,r),Ji.appendChild(t)}}function Hr(){const s=be.isCatalogActive;kf.hidden=!s,s&&(TM.textContent=be.robotName,Bf.hidden=be.isSupported)}Ff.addEventListener("click",()=>{Ji.hidden=!Ji.hidden});Bf.addEventListener("click",()=>{be.deleteCustom(be.robotName),kf.hidden=!0,Ji.hidden=!0,va()});wM.addEventListener("click",s=>{s.stopPropagation(),bd.hidden=!bd.hidden});va();Hr();const Hf=new Map;function jn(){const s=new Map,e=be.getComponentEntries();for(const{type:n}of e)s.set(n,(s.get(n)??0)+1);for(const[n,i]of Hf){const r=s.get(n)??0;i.textContent=r>0?String(r):"",i.style.display=r>0?"inline":"none"}const t=e.length;RM.textContent=t>0?`${t} added`:"",LM.hidden=t>0||!be.isCatalogActive}for(const[s,e]of Object.entries(Nn)){if(e.geomType==="mesh"||e.hidden)continue;const t=document.createElement("button");t.type="button",t.className="robot-btn",t.style.cssText="position: relative;",t.textContent=e.label,t.dataset.comp=s;const n=document.createElement("span");n.style.cssText="position:absolute;top:2px;right:3px;font-size:9px;line-height:1;color:var(--blue);display:none;font-weight:700;",t.appendChild(n),Hf.set(s,n),t.addEventListener("click",()=>{var r;if(!be.isCatalogActive)return;const i=be.addComponent(s);xa(i),ls(i,s),jn(),(r=Kn.querySelector(`[data-id="${i}"]`))==null||r.scrollIntoView({behavior:"smooth",block:"nearest"})}),MM.appendChild(t)}const Zs=new Map,Js=new Map;let kt=null,Ri=null;function ya(){Kn.innerHTML="",rs()}function rs(){kt=null,Ri=null;for(const s of Kn.querySelectorAll(".build-component"))s.classList.remove("selected");Oc.hidden=!0,Ns.innerHTML="",Zs.clear(),Js.clear(),ea(null)}function ea(s){if(wl.innerHTML="",wl.hidden=!s,!s)return;const e=document.createElement("span");e.className="context-pill";const t=document.createElement("span");t.className="context-pill-dot",t.style.background=s.color;const n=document.createElement("span");n.textContent=s.label;const i=document.createElement("button");i.type="button",i.className="context-pill-dismiss",i.textContent="×",i.title="Deselect",i.addEventListener("click",s.onDismiss),e.append(t,n,i),wl.appendChild(e)}function xa(s){for(const[e,t]of Js)if(e!==s&&!Array.from(t.options).some(n=>n.value===s)){const n=document.createElement("option");n.value=n.textContent=s,t.appendChild(n)}}function Fc(s){for(const e of Js.values()){const t=Array.from(e.options).find(n=>n.value===s);t&&e.removeChild(t)}}function ba(s){kt=s,Ri=null;for(const n of Kn.querySelectorAll(".build-component"))n.classList.toggle("selected",n.dataset.id===s);const e=be.getComponentEntries().find(n=>n.id===s);e&&Vf(s,e.type);const t=Nn[(e==null?void 0:e.type)??""];ea({label:`${(t==null?void 0:t.label)??(e==null?void 0:e.type)??s} · ${s}`,color:(t==null?void 0:t.cssColor)??"#888",onDismiss:rs})}function ls(s,e,t){const n=Nn[e],i=document.createElement("div");i.className="build-component",i.dataset.id=s;const r=document.createElement("div");r.className="build-component-header";const o=document.createElement("span");o.style.cssText=`width:7px;height:7px;border-radius:50%;flex-shrink:0;background:${(n==null?void 0:n.cssColor)??"#888"}`;const a=document.createElement("span");a.textContent=`${n.label} ${s.split("_").pop()}`;const l=document.createElement("button");l.type="button",l.className="build-remove-btn",l.title="Duplicate",l.textContent="⧉",l.addEventListener("click",h=>{var d;h.stopPropagation();const u=be.duplicateComponent(s);u&&(xa(u),ls(u,e),((d=Nn[e])==null?void 0:d.geomType)==="mesh"&&Kf(u,e),jn())});const c=document.createElement("button");c.type="button",c.className="build-remove-btn",c.title="Remove",c.textContent="×",c.addEventListener("click",h=>{h.stopPropagation(),be.removeComponent(s),kt===s&&rs(),Fc(s),i.remove(),jn()}),r.addEventListener("click",()=>ba(s)),r.append(o,a,l,c),i.appendChild(r),Kn.appendChild(i)}function Vf(s,e){var b,E;const t=be.getComponentData(s);if(!t)return;const n=Nn[e];Ns.innerHTML="",Zs.delete(s),Js.delete(s);const i={},r={};function o(){var C,D,M,v,U,z,F;const I=n.geomType==="cylinder"?[parseFloat(i.r.value)||.001,parseFloat(i.l.value)||.001]:[parseFloat(i.w.value)||.001,parseFloat(i.d.value)||.001,parseFloat(i.h.value)||.001],P=((C=r.jt)==null?void 0:C.value)??"fixed";be.updateComponent(s,{x:parseFloat(i.x.value)||0,y:parseFloat(i.y.value)||0,z:parseFloat(i.z.value)||0,rx:parseFloat(i.rx.value)||0,ry:parseFloat(i.ry.value)||0,rz:parseFloat(i.rz.value)||0,dims:I,jointType:P,axis:[parseFloat((D=i.ax)==null?void 0:D.value)||0,parseFloat((M=i.ay)==null?void 0:M.value)||0,parseFloat((v=i.az)==null?void 0:v.value)||1],limitLower:parseFloat((U=i.limitMin)==null?void 0:U.value)||-1.5708,limitUpper:parseFloat((z=i.limitMax)==null?void 0:z.value)||1.5708,parent:((F=r.parent)==null?void 0:F.value)??"base_link"})}function a(I,P,C,D,M,v=Ns){const U=document.createElement("div");U.className="inspector-row";const z=document.createElement("label");z.className=P,z.textContent=C;const F=document.createElement("input");F.type="number",F.step=String(D),F.value=String(M),F.addEventListener("input",o),Df(z,F),i[I]=F,U.append(z,F),v.appendChild(U)}function l(I,P=Ns){const C=document.createElement("div");C.className="build-group-label",C.textContent=I,P.appendChild(C)}function c(I,P,C,D=Ns){const M=document.createElement("div");M.className="inspector-row";const v=document.createElement("label");v.textContent=P;const U=document.createElement("select");U.className="build-select";for(const z of C){const F=document.createElement("option");F.value=F.textContent=z,U.appendChild(F)}U.addEventListener("change",o),r[I]=U,M.append(v,U),D.appendChild(M)}l("Position"),a("x","axis-x","X",.005,t.x??0),a("y","axis-y","Y",.005,t.y??0),a("z","axis-z","Z",.005,t.z??n.defaultZ),l("Size"),n.geomType==="cylinder"?(a("r","axis-x","R",.005,t.dims[0]??n.defaultDims[0]),a("l","axis-z","L",.005,t.dims[1]??n.defaultDims[1])):(a("w","axis-x","W",.005,t.dims[0]??n.defaultDims[0]),a("d","axis-y","D",.005,t.dims[1]??n.defaultDims[1]),a("h","axis-z","H",.005,t.dims[2]??n.defaultDims[2]));const h=t.jointType??"fixed",u=h==="revolute"||h==="prismatic",d=document.createElement("details");d.className="build-comp-advanced",h!=="fixed"&&(d.open=!0);const f=document.createElement("summary");f.textContent="Rotation · Joint · Limits",d.appendChild(f),Ns.appendChild(d),l("Rotation",d),a("rx","axis-x","Rx",.01,t.rx??0,d),a("ry","axis-y","Ry",.01,t.ry??0,d),a("rz","axis-z","Rz",.01,t.rz??0,d),l("Joint",d),c("parent","Parent",be.getAvailableLinks().filter(I=>I!==s),d),c("jt","Type",["fixed","continuous","revolute","prismatic"],d),t.parent&&r.parent&&(r.parent.value=t.parent),t.jointType&&r.jt&&(r.jt.value=t.jointType);const g=document.createElement("div");l("Axis",g),a("ax","axis-x","X",.1,t.axis[0]??0,g),a("ay","axis-y","Y",.1,t.axis[1]??0,g),a("az","axis-z","Z",.1,t.axis[2]??1,g),g.hidden=h==="fixed",d.appendChild(g);const _=document.createElement("div");l("Limits",_),a("limitMin","axis-x","Min",.01,t.limitLower??-1.5708,_),a("limitMax","axis-z","Max",.01,t.limitUpper??1.5708,_),_.hidden=!u,d.appendChild(_);const p=document.createElement("div"),m=document.createElement("input");m.type="range",m.step="0.01",m.min=String(t.limitLower??-1.5708),m.max=String(t.limitUpper??1.5708),m.value="0",m.dataset.preview="true",m.style.cssText="width: 100%; margin-top: 2px;",m.addEventListener("input",()=>{var I;(I=Ue.robot)==null||I.setJointValue(`${s}_joint`,parseFloat(m.value))}),(b=i.limitMin)==null||b.addEventListener("input",()=>{m.min=i.limitMin.value}),(E=i.limitMax)==null||E.addEventListener("input",()=>{m.max=i.limitMax.value}),l("Preview",p);const T=document.createElement("div");T.className="build-preview-row",T.appendChild(m),p.appendChild(T),p.hidden=!u,d.appendChild(p),r.jt.addEventListener("change",()=>{var C;const I=r.jt.value,P=I==="revolute"||I==="prismatic";g.hidden=I==="fixed",_.hidden=!P,p.hidden=!P,I!=="fixed"&&!d.open&&(d.open=!0),P||(m.value="0",(C=Ue.robot)==null||C.setJointValue(`${s}_joint`,0))}),Zs.set(s,i),r.parent&&Js.set(s,r.parent),PM.textContent=`${n.label} · ${s}`,Oc.hidden=!1}function IM(s){const e=Kn.querySelector(`[data-id="${s}"]`);Zs.delete(s),Js.delete(s),Fc(s),kt===s&&rs(),e==null||e.remove()}{const s={isEditorTabActive:()=>document.body.classList.contains("editor-open"),handleEditorInput:e=>un.handleExternalInput(e),onComponentAdded:(e,t)=>{xa(e),ls(e,t)},onComponentRemoved:e=>IM(e),syncSlidersFromController:$r,switchToBuildTab:()=>Te("tab-build").click(),onBriefToggle:e=>{un.brief=e},refreshPaletteCounts:jn,getPartsList:()=>un.partsList,readPart:e=>un.readPart(e),updatePart:(e,t)=>un.writePart(e,t),highlightPart:e=>qr(e),getJointNames:()=>{var e;return Object.keys(((e=Ue.robot)==null?void 0:e.joints)??{})},getFocusedComponent:()=>{var e;if(kt){const t=be.getComponentEntries().find(n=>n.id===kt);return t?{id:kt,type:t.type,data:be.getComponentData(kt)}:null}if(Ri){const t=(e=Ue.robot)==null?void 0:e.joints[Ri];if(!t)return null;const n=t.position,i=t.jointType??"fixed";return{id:Ri,type:i,data:{type:i,x:n.x,y:n.y,z:n.z,rx:0,ry:0,rz:0,dims:[],jointType:i,axis:[0,0,1],limitLower:0,limitUpper:0,parent:"base_link"}}}return null}};Cr=new sM(be,s),Cr.init()}const ui=new _c,Ma=new _e,Xl=new An,ql=new An,$l=new k,Gf=new k,yr=new k;let Li=null,wn=null,Wf=0,jf=0,Xf=0,Fs=0,ks=0,Bs=0,qf=0,$f=0;function kc(s){const e=Ue.renderer.domElement.getBoundingClientRect();Ma.set((s.clientX-e.left)/e.width*2-1,-((s.clientY-e.top)/e.height)*2+1)}function Yf(s){const e=be.componentIds;let t=s;for(;t;){if(t.isURDFLink&&t.urdfName&&e.has(t.urdfName))return t.urdfName;t=t.parent}return null}Ue.renderer.domElement.addEventListener("pointerdown",s=>{if(!be.isCatalogActive)return;kc(s),ui.setFromCamera(Ma,Ue.camera);const e=ui.intersectObject(Ue.scene,!0);if(!e.length)return;const t=Yf(e[0].object);if(!t||!be.isFixedComponent(t))return;const n=be.getComponentXYZ(t);if(!n)return;Xl.set(new k(0,1,0),-n.z),ui.ray.intersectPlane(Xl,$l);const i=new k;Ue.camera.getWorldDirection(i),i.y=0,i.normalize(),ql.setFromNormalAndCoplanarPoint(i,new k(n.x,n.z,-n.y)),ui.ray.intersectPlane(ql,Gf),Li=t,Wf=n.x,jf=n.y,Xf=n.z,Fs=n.z,ks=n.x,Bs=n.y,be.startComponentDrag(t),Ue.controls.enabled=!1,qf=s.clientX,$f=s.clientY,wn=Kn.querySelector(`[data-id="${t}"]`),wn==null||wn.classList.add("dragging"),ba(t),Ue.renderer.domElement.setPointerCapture(s.pointerId),s.stopPropagation()});Ue.renderer.domElement.addEventListener("pointermove",s=>{var i;if(!Li)return;kc(s),ui.setFromCamera(Ma,Ue.camera);const e=(i=Ue.robot)==null?void 0:i.joints[`${Li}_joint`],t=Zs.get(Li),n=.001;if(Ue.renderer.domElement.style.cursor=s.shiftKey?"ns-resize":"grabbing",s.shiftKey){if(!ui.ray.intersectPlane(ql,yr))return;Fs=Math.round((Xf+(yr.y-Gf.y))/n)*n,e&&e.position.set(ks,Bs,Fs),t&&(t.z.value=Fs.toFixed(4))}else{if(!ui.ray.intersectPlane(Xl,yr))return;ks=Math.round((Wf+(yr.x-$l.x))/n)*n,Bs=Math.round((jf-(yr.z-$l.z))/n)*n,e&&e.position.set(ks,Bs,Fs),t&&(t.x.value=ks.toFixed(4),t.y.value=Bs.toFixed(4))}});Ue.renderer.domElement.addEventListener("pointerup",s=>{if(!Li)return;const e=Math.hypot(s.clientX-qf,s.clientY-$f)>8;if(be.finishComponentDrag(Li,ks,Bs,Fs),Ue.controls.enabled=!0,Ue.renderer.domElement.style.cursor="",wn==null||wn.classList.remove("dragging"),!e&&wn){const t=wn.dataset.id;t&&ba(t),wn.scrollIntoView({behavior:"smooth",block:"nearest"})}wn=null,Li=null});const Xi=Te("build-hover-tip");let Ed=0;Ue.renderer.domElement.addEventListener("pointermove",s=>{if(!be.isCatalogActive||Li){Xi.style.display="none";return}cancelAnimationFrame(Ed),Ed=requestAnimationFrame(()=>{var n;kc(s),ui.setFromCamera(Ma,Ue.camera);const e=ui.intersectObject(Ue.scene,!0),t=e.length?Yf(e[0].object):null;if(t){const i=Nn[((n=be.getComponentData(t))==null?void 0:n.type)??""];Xi.textContent=i?`${i.label} #${t.split("_").pop()}`:t,Xi.style.display="block",Xi.style.left=s.clientX+12+"px",Xi.style.top=s.clientY-28+"px"}else Xi.style.display="none"})});Ue.renderer.domElement.addEventListener("pointerleave",()=>{Xi.style.display="none"});function Kf(s,e){const t=Ti.find(n=>n.id===e);t&&t.factory().then(({generate:n})=>be.restoreMeshBlob(s,n())).catch(n=>console.warn("[regenMeshBlob] failed for",s,n))}const DM={Sensor:"📡",Actuator:"⚙️",MCU:"💾",Power:"🔋",Structural:"🧱"};let Yl="";function Bc(){const s=be.isCatalogActive,e=zf.value.trim().toLowerCase();AM.hidden=s;const t=Ti.filter(n=>!(Yl&&n.category!==Yl||e&&!n.label.toLowerCase().includes(e)&&!n.description.toLowerCase().includes(e)));Sd.innerHTML="",CM.hidden=t.length>0;for(const n of t)Sd.appendChild(UM(n,s))}function UM(s,e){const t=document.createElement("div");t.className="lib-card";const n=document.createElement("div");n.className="lib-thumb",n.style.background=s.cssColor+"33",n.style.borderBottom=`2px solid ${s.cssColor}`,n.textContent=DM[s.category]??"📦";const i=document.createElement("div");i.className="lib-card-info";const r=document.createElement("div");r.className="lib-card-name",r.textContent=s.label,r.title=s.description;const o=document.createElement("div");o.className="lib-card-meta";const a=Object.assign(document.createElement("span"),{className:"lib-card-cat",textContent:s.category}),l=s.defaultDims.map(u=>Math.round(u*1e3)).join("×")+" mm",c=Object.assign(document.createElement("span"),{className:"lib-card-dims",textContent:l});o.append(a,c);const h=document.createElement("button");return h.type="button",h.className="lib-card-add",h.textContent="Add to Build",h.disabled=!e,h.addEventListener("click",()=>void OM(s,h)),i.append(r,o,h),t.append(n,i),t}async function OM(s,e){var n;if(!be.isCatalogActive)return;const t=e.textContent??"Add to Build";e.disabled=!0,e.textContent="Generating…";try{const{generate:i}=await s.factory(),r=i(),o=be.addMeshComponent(s.id,r);xa(o),ls(o,s.id),jn(),Te("tab-build").click(),(n=Kn.querySelector(`[data-id="${o}"]`))==null||n.scrollIntoView({behavior:"smooth",block:"nearest"})}catch(i){console.error("[Library] generate failed:",i),e.textContent="Error",setTimeout(()=>{e.textContent=t,e.disabled=!be.isCatalogActive},2e3);return}e.textContent=t,e.disabled=!1}zf.addEventListener("input",Bc);for(const s of Md.querySelectorAll(".lib-pill"))s.addEventListener("click",()=>{for(const e of Md.querySelectorAll(".lib-pill"))e.classList.remove("lib-pill--active");s.classList.add("lib-pill--active"),Yl=s.dataset.cat??"",Bc()});export{er as B,lc as C,_c as R,Bu as S,k as V,_e as a,Zb as g,FM as m};
