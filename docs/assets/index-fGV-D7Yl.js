...
${r}PARTS (auto-summarised — use this to understand the complete robot topology):
${c}
...
`)}customElements.define("urdf-viewer",zx);const ot=document.getElementById("viewer"),Ui=document.getElementById("joints"),As=document.getElementById("robots"),Ka=document.getElementById("loading"),Ks=document.getElementById("part-label"),pa=document.getElementById("gesture-toggle"),Kx=document.getElementById("gesture-overlay"),$x=document.getElementById("gesture-video"),vu=document.getElementById("gesture-section"),$s=document.getElementById("gesture-section-header"),Zx=document.getElementById("editor-panel"),Zs=new Ca(ot,Zx);document.getElementById("tab-robot").addEventListener("click",()=>Zs.close());document.getElementById("tab-editor").addEventListener("click",()=>Zs.open());const xh=document.getElementById("ignore-limits"),vh=document.getElementById("show-collision"),La=document.getElementById("display-shadow"),so=document.getElementById("up-axis");function Jx(s,e){const t=[...e.entries()].sort(([r],[o])=>r.localeCompare(o)),n=t.filter(([r])=>r.startsWith("00")).map(([,r])=>r.trimEnd()).join(`
