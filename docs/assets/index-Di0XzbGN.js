...
#endif`,Wg="gl_FragColor = linearToOutputTexel( gl_FragColor );",jg=`
...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Li,depthTest:!1,depthWrite:!1})}function uu(){return new Oi({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:fc(),fragmentShader:`
		...
		`,blending:Li,depthTest:!1,depthWrite:!1})}function du(){return new Oi({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:fc(),fragmentShader:`
	...
	`}function ny(s){let e=new WeakMap,t=null;function n(a){if(a&&a.isTexture){const l=a.mapping,c=l===Hl||l===Vl,h=l===Ys||l===Ks;if(c||h){let u=e.get(a);const d=u!==void 0?u.texture.pmremVersion:0;if(a.isRenderTargetTexture&&a.pmremVersion!==d)return t===null&&(t=new cu(s)),u=c?t.fromEquirectangular(a,u):t.fromCubemap(a,u),u.texture.pmremVersion=a.pmremVersion,e.set(a,u),u.texture;if(u!==void 0)return u.texture;{const f=a.image;return c&&f&&f.height>0||h&&f&&i(f)?(t===null&&(t=new cu(s)),u=c?t.fromEquirectangular(a):t.fromCubemap(a),u.texture.pmremVersion=a.pmremVersion,e.set(a,u),a.addEventListener("dispose",r),u.texture):null}}}return a}function i(a){let l=0;const c=6;for(let h=0;h<c;h++)a[h]!==void 0&&l++;return l===c}function r(a){const l=a.target;l.removeEventListener("dispose",r);const c=e.get(l);c!==void 0&&(e.delete(l),c.dispose())}function o(){e=new WeakMap,t!==null&&(t.dispose(),t=null)}return{get:n,dispose:o}}function iy(s){const e={};function t(n){if(e[n]!==void 0)return e[n];let i;switch(n){case"WEBGL_depth_texture":i=s.getExtension("WEBGL_depth_texture")||s.getExtension("MOZ_WEBGL_depth_texture")||s.getExtension("WEBKIT_WEBGL_depth_texture");break;case"EXT_texture_filter_anisotropic":i=s.getExtension("EXT_texture_filter_anisotropic")||s.getExtension("MOZ_EXT_texture_filter_anisotropic")||s.getExtension("WEBKIT_EXT_texture_filter_anisotropic");break;case"WEBGL_compressed_texture_s3tc":i=s.getExtension("WEBGL_compressed_texture_s3tc")||s.getExtension("MOZ_WEBGL_compressed_texture_s3tc")||s.getExtension("WEBKIT_WEBGL_compressed_texture_s3tc");break;case"WEBGL_compressed_texture_pvrtc":i=s.getExtension("WEBGL_compressed_texture_pvrtc")||s.getExtension("WEBKIT_WEBGL_compressed_texture_pvrtc");break;default:i=s.getExtension(n)}return e[n]=i,i}return{has:function(n){return t(n)!==null},init:function(){t("EXT_color_buffer_float"),t("WEBGL_clip_cull_distance"),t("OES_texture_float_linear"),t("EXT_color_buffer_half_float"),t("WEBGL_multisampled_render_to_texture"),t("WEBGL_render_shared_exponent")},get:function(n){const i=t(n);return i===null&&console.warn("THREE.WebGLRenderer: "+n+" extension not supported."),i}}}function sy(s,e,t,n){const i={},r=new WeakMap;function o(u){const d=u.target;d.index!==null&&e.remove(d.index);for(const g in d.attributes)e.remove(d.attributes[g]);for(const g in d.morphAttributes){const _=d.morphAttributes[g];for(let p=0,m=_.length;p<m;p++)e.remove(_[p])}d.removeEventListener("dispose",o),delete i[d.id];const f=r.get(d);f&&(e.remove(f),r.delete(d)),n.releaseStatesOfGeometry(d),d.isInstancedBufferGeometry===!0&&delete d._maxInstanceCount,t.memory.geometries--}function a(u,d){return i[d.id]===!0||(d.addEventListener("dispose",o),i[d.id]=!0,t.memory.geometries++),d}function l(u){const d=u.attributes;for(const g in d)e.update(d[g],s.ARRAY_BUFFER);const f=u.morphAttributes;for(const g in f){const _=f[g];for(let p=0,m=_.length;p<m;p++)e.update(_[p],s.ARRAY_BUFFER)}}function c(u){const d=[],f=u.index,g=u.attributes.position;let _=0;if(f!==null){const w=f.array;_=f.version;for(let v=0,S=w.length;v<S;v+=3){const I=w[v+0],P=w[v+1],C=w[v+2];d.push(I,P,P,C,C,I)}}else if(g!==void 0){const w=g.array;_=g.version;for(let v=0,S=w.length/3-1;v<S;v+=3){const I=v+0,P=v+1,C=v+2;d.push(I,P,P,C,C,I)}}else return;const p=new(sf(d)?hf:cf)(d,1);p.version=_;const m=r.get(u);m&&e.remove(m),r.set(u,p)}function h(u){const d=r.get(u);if(d){const f=u.index;f!==null&&d.version<f.version&&c(u)}else c(u);return r.get(u)}return{get:a,update:l,getWireframeAttribute:h}}function ry(s,e,t){let n;function i(d){n=d}let r,o;function a(d){r=d.type,o=d.bytesPerElement}function l(d,f){s.drawElements(n,f,r,d*o),t.update(f,n,1)}function c(d,f,g){g!==0&&(s.drawElementsInstanced(n,f,r,d*o,g),t.update(f,n,g))}function h(d,f,g){if(g===0)return;const _=e.get("WEBGL_multi_draw");if(_===null)for(let p=0;p<g;p++)this.render(d[p]/o,f[p]);else{_.multiDrawElementsWEBGL(n,f,0,r,d,0,g);let p=0;for(let m=0;m<g;m++)p+=f[m];t.update(p,n,1)}}function u(d,f,g,_){if(g===0)return;const p=e.get("WEBGL_multi_draw");if(p===null)for(let m=0;m<d.length;m++)c(d[m]/o,f[m],_[m]);else{p.multiDrawElementsInstancedWEBGL(n,f,0,r,d,0,_,0,g);let m=0;for(let w=0;w<g;w++)m+=f[w];for(let w=0;w<_.length;w++)t.update(m,n,_[w])}}this.setMode=i,this.setIndex=a,this.render=l,this.renderInstances=c,this.renderMultiDraw=h,this.renderMultiDrawInstances=u}function oy(s){const e={geometries:0,textures:0},t={frame:0,calls:0,triangles:0,points:0,lines:0};function n(r,o,a){switch(t.calls++,o){case s.TRIANGLES:t.triangles+=a*(r/3);break;case s.LINES:t.lines+=a*(r/2);break;case s.LINE_STRIP:t.lines+=a*(r-1);break;case s.LINE_LOOP:t.lines+=a*r;break;case s.POINTS:t.points+=a*r;break;default:console.error("THREE.WebGLInfo: Unknown draw mode:",o);break}}function i(){t.calls=0,t.triangles=0,t.points=0,t.lines=0}return{memory:e,render:t,programs:null,autoReset:!0,reset:i,update:n}}function ay(s,e,t){const n=new WeakMap,i=new Tt;function r(o,a,l){const c=o.morphTargetInfluences,h=a.morphAttributes.position||a.morphAttributes.normal||a.morphAttributes.color,u=h!==void 0?h.length:0;let d=n.get(a);if(d===void 0||d.count!==u){let E=function(){C.dispose(),n.delete(a),a.removeEventListener("dispose",E)};d!==void 0&&d.texture.dispose();const f=a.morphAttributes.position!==void 0,g=a.morphAttributes.normal!==void 0,_=a.morphAttributes.color!==void 0,p=a.morphAttributes.position||[],m=a.morphAttributes.normal||[],w=a.morphAttributes.color||[];let v=0;f===!0&&(v=1),g===!0&&(v=2),_===!0&&(v=3);let S=a.attributes.position.count*v,I=1;S>e.maxTextureSize&&(I=Math.ceil(S/e.maxTextureSize),S=e.maxTextureSize);const P=new Float32Array(S*I*4*u),C=new af(P,S,I,u);C.type=jn,C.needsUpdate=!0;const D=v*4;for(let y=0;y<u;y++){const U=p[y],z=m[y],F=w[y],H=S*I*4*y;for(let Z=0;Z<U.count;Z++){const B=Z*D;f===!0&&(i.fromBufferAttribute(U,Z),P[H+B+0]=i.x,P[H+B+1]=i.y,P[H+B+2]=i.z,P[H+B+3]=0),g===!0&&(i.fromBufferAttribute(z,Z),P[H+B+4]=i.x,P[H+B+5]=i.y,P[H+B+6]=i.z,P[H+B+7]=0),_===!0&&(i.fromBufferAttribute(F,Z),P[H+B+8]=i.x,P[H+B+9]=i.y,P[H+B+10]=i.z,P[H+B+11]=F.itemSize===4?i.w:1)}}d={count:u,texture:C,size:new ye(S,I)},n.set(a,d),a.addEventListener("dispose",E)}if(o.isInstancedMesh===!0&&o.morphTexture!==null)l.getUniforms().setValue(s,"morphTexture",o.morphTexture,t);else{let f=0;for(let _=0;_<c.length;_++)f+=c[_];const g=a.morphTargetsRelative?1:1-f;l.getUniforms().setValue(s,"morphTargetBaseInfluence",g),l.getUniforms().setValue(s,"morphTargetInfluences",c)}l.getUniforms().setValue(s,"morphTargetsTexture",d.texture,t),l.getUniforms().setValue(s,"morphTargetsTextureSize",d.size)}return{update:r}}function ly(s,e,t,n){let i=new WeakMap;function r(l){const c=n.render.frame,h=l.geometry,u=e.get(l,h);if(i.get(u)!==c&&(e.update(u),i.set(u,c)),l.isInstancedMesh&&(l.hasEventListener("dispose",a)===!1&&l.addEventListener("dispose",a),i.get(l)!==c&&(t.update(l.instanceMatrix,s.ARRAY_BUFFER),l.instanceColor!==null&&t.update(l.instanceColor,s.ARRAY_BUFFER),i.set(l,c))),l.isSkinnedMesh){const d=l.skeleton;i.get(d)!==c&&(d.update(),i.set(d,c))}return u}function o(){i=new WeakMap}function a(l){const c=l.target;c.removeEventListener("dispose",a),t.remove(c.instanceMatrix),c.instanceColor!==null&&t.remove(c.instanceColor)}return{update:r,dispose:o}}class mf extends Vt{constructor(e,t,n,i,r,o,a,l,c,h){if(h=h!==void 0?h:js,h!==js&&h!==kr)throw new Error("DepthTexture format must be either THREE.DepthFormat or THREE.DepthStencilFormat");n===void 0&&h===js&&(n=Js),n===void 0&&h===kr&&(n=$r),super(null,i,r,o,a,l,h,n,c),this.isDepthTexture=!0,this.image={width:e,height:t},this.magFilter=a!==void 0?a:rn,this.minFilter=l!==void 0?l:rn,this.flipY=!1,this.generateMipmaps=!1,this.compareFunction=null}copy(e){return super.copy(e),this.compareFunction=e.compareFunction,this}toJSON(e){const t=super.toJSON(e);return this.compareFunction!==null&&(t.compareFunction=this.compareFunction),t}}const gf=new Vt,_f=new mf(1,1);_f.compareFunction=nf;const yf=new af,vf=new $m,xf=new ff,fu=[],pu=[],mu=new Float32Array(16),gu=new Float32Array(9),_u=new Float32Array(4);function ar(s,e,t){const n=s[0];if(n<=0||n>0)return s;const i=e*t;let r=fu[i];if(r===void 0&&(r=new Float32Array(i),fu[i]=r),e!==0){n.toArray(r,0);for(let o=1,a=0;o!==e;++o)a+=t,s[o].toArray(r,a)}return r}function Gt(s,e){if(s.length!==e.length)return!1;for(let t=0,n=s.length;t<n;t++)if(s[t]!==e[t])return!1;return!0}function Wt(s,e){for(let t=0,n=e.length;t<n;t++)s[t]=e[t]}function va(s,e){let t=pu[e];t===void 0&&(t=new Int32Array(e),pu[e]=t);for(let n=0;n!==e;++n)t[n]=s.allocateTextureUnit();return t}function cy(s,e){const t=this.cache;t[0]!==e&&(s.uniform1f(this.addr,e),t[0]=e)}function hy(s,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(s.uniform2f(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(Gt(t,e))return;s.uniform2fv(this.addr,e),Wt(t,e)}}function uy(s,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(s.uniform3f(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else if(e.r!==void 0)(t[0]!==e.r||t[1]!==e.g||t[2]!==e.b)&&(s.uniform3f(this.addr,e.r,e.g,e.b),t[0]=e.r,t[1]=e.g,t[2]=e.b);else{if(Gt(t,e))return;s.uniform3fv(this.addr,e),Wt(t,e)}}function dy(s,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(s.uniform4f(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(Gt(t,e))return;s.uniform4fv(this.addr,e),Wt(t,e)}}function fy(s,e){const t=this.cache,n=e.elements;if(n===void 0){if(Gt(t,e))return;s.uniformMatrix2fv(this.addr,!1,e),Wt(t,e)}else{if(Gt(t,n))return;_u.set(n),s.uniformMatrix2fv(this.addr,!1,_u),Wt(t,n)}}function py(s,e){const t=this.cache,n=e.elements;if(n===void 0){if(Gt(t,e))return;s.uniformMatrix3fv(this.addr,!1,e),Wt(t,e)}else{if(Gt(t,n))return;gu.set(n),s.uniformMatrix3fv(this.addr,!1,gu),Wt(t,n)}}function my(s,e){const t=this.cache,n=e.elements;if(n===void 0){if(Gt(t,e))return;s.uniformMatrix4fv(this.addr,!1,e),Wt(t,e)}else{if(Gt(t,n))return;mu.set(n),s.uniformMatrix4fv(this.addr,!1,mu),Wt(t,n)}}function gy(s,e){const t=this.cache;t[0]!==e&&(s.uniform1i(this.addr,e),t[0]=e)}function _y(s,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(s.uniform2i(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(Gt(t,e))return;s.uniform2iv(this.addr,e),Wt(t,e)}}function yy(s,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(s.uniform3i(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(Gt(t,e))return;s.uniform3iv(this.addr,e),Wt(t,e)}}function vy(s,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(s.uniform4i(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(Gt(t,e))return;s.uniform4iv(this.addr,e),Wt(t,e)}}function xy(s,e){const t=this.cache;t[0]!==e&&(s.uniform1ui(this.addr,e),t[0]=e)}function by(s,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(s.uniform2ui(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(Gt(t,e))return;s.uniform2uiv(this.addr,e),Wt(t,e)}}function Ey(s,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(s.uniform3ui(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(Gt(t,e))return;s.uniform3uiv(this.addr,e),Wt(t,e)}}function My(s,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(s.uniform4ui(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(Gt(t,e))return;s.uniform4uiv(this.addr,e),Wt(t,e)}}function Sy(s,e,t){const n=this.cache,i=t.allocateTextureUnit();n[0]!==i&&(s.uniform1i(this.addr,i),n[0]=i);const r=this.type===s.SAMPLER_2D_SHADOW?_f:gf;t.setTexture2D(e||r,i)}function wy(s,e,t){const n=this.cache,i=t.allocateTextureUnit();n[0]!==i&&(s.uniform1i(this.addr,i),n[0]=i),t.setTexture3D(e||vf,i)}function Ty(s,e,t){const n=this.cache,i=t.allocateTextureUnit();n[0]!==i&&(s.uniform1i(this.addr,i),n[0]=i),t.setTextureCube(e||xf,i)}function Ay(s,e,t){const n=this.cache,i=t.allocateTextureUnit();n[0]!==i&&(s.uniform1i(this.addr,i),n[0]=i),t.setTexture2DArray(e||yf,i)}function Cy(s){switch(s){case 5126:return cy;case 35664:return hy;case 35665:return uy;case 35666:return dy;case 35674:return fy;case 35675:return py;case 35676:return my;case 5124:case 35670:return gy;case 35667:case 35671:return _y;case 35668:case 35672:return yy;case 35669:case 35673:return vy;case 5125:return xy;case 36294:return by;case 36295:return Ey;case 36296:return My;case 35678:case 36198:case 36298:case 36306:case 35682:return Sy;case 35679:case 36299:case 36307:return wy;case 35680:case 36300:case 36308:case 36293:return Ty;case 36289:case 36303:case 36311:case 36292:return Ay}}function Ry(s,e){s.uniform1fv(this.addr,e)}function Ly(s,e){const t=ar(e,this.size,2);s.uniform2fv(this.addr,t)}function Py(s,e){const t=ar(e,this.size,3);s.uniform3fv(this.addr,t)}function Ny(s,e){const t=ar(e,this.size,4);s.uniform4fv(this.addr,t)}function Iy(s,e){const t=ar(e,this.size,4);s.uniformMatrix2fv(this.addr,!1,t)}function Dy(s,e){const t=ar(e,this.size,9);s.uniformMatrix3fv(this.addr,!1,t)}function Uy(s,e){const t=ar(e,this.size,16);s.uniformMatrix4fv(this.addr,!1,t)}function Oy(s,e){s.uniform1iv(this.addr,e)}function Fy(s,e){s.uniform2iv(this.addr,e)}function ky(s,e){s.uniform3iv(this.addr,e)}function By(s,e){s.uniform4iv(this.addr,e)}function zy(s,e){s.uniform1uiv(this.addr,e)}function Hy(s,e){s.uniform2uiv(this.addr,e)}function Vy(s,e){s.uniform3uiv(this.addr,e)}function Gy(s,e){s.uniform4uiv(this.addr,e)}function Wy(s,e,t){const n=this.cache,i=e.length,r=va(t,i);Gt(n,r)||(s.uniform1iv(this.addr,r),Wt(n,r));for(let o=0;o!==i;++o)t.setTexture2D(e[o]||gf,r[o])}function jy(s,e,t){const n=this.cache,i=e.length,r=va(t,i);Gt(n,r)||(s.uniform1iv(this.addr,r),Wt(n,r));for(let o=0;o!==i;++o)t.setTexture3D(e[o]||vf,r[o])}function Xy(s,e,t){const n=this.cache,i=e.length,r=va(t,i);Gt(n,r)||(s.uniform1iv(this.addr,r),Wt(n,r));for(let o=0;o!==i;++o)t.setTextureCube(e[o]||xf,r[o])}function qy(s,e,t){const n=this.cache,i=e.length,r=va(t,i);Gt(n,r)||(s.uniform1iv(this.addr,r),Wt(n,r));for(let o=0;o!==i;++o)t.setTexture2DArray(e[o]||yf,r[o])}function $y(s){switch(s){case 5126:return Ry;case 35664:return Ly;case 35665:return Py;case 35666:return Ny;case 35674:return Iy;case 35675:return Dy;case 35676:return Uy;case 5124:case 35670:return Oy;case 35667:case 35671:return Fy;case 35668:case 35672:return ky;case 35669:case 35673:return By;case 5125:return zy;case 36294:return Hy;case 36295:return Vy;case 36296:return Gy;case 35678:case 36198:case 36298:case 36306:case 35682:return Wy;case 35679:case 36299:case 36307:return jy;case 35680:case 36300:case 36308:case 36293:return Xy;case 36289:case 36303:case 36311:case 36292:return qy}}class Yy{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.setValue=Cy(t.type)}}class Ky{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.size=t.size,this.setValue=$y(t.type)}}class Jy{constructor(e){this.id=e,this.seq=[],this.map={}}setValue(e,t,n){const i=this.seq;for(let r=0,o=i.length;r!==o;++r){const a=i[r];a.setValue(e,t[a.id],n)}}}const hl=/(\w+)(\])?(\[|\.)?/g;function yu(s,e){s.seq.push(e),s.map[e.id]=e}function Zy(s,e,t){const n=s.name,i=n.length;for(hl.lastIndex=0;;){const r=hl.exec(n),o=hl.lastIndex;let a=r[1];const l=r[2]==="]",c=r[3];if(l&&(a=a|0),c===void 0||c==="["&&o+2===i){yu(t,c===void 0?new Yy(a,s,e):new Ky(a,s,e));break}else{let u=t.map[a];u===void 0&&(u=new Jy(a),yu(t,u)),t=u}}}class Jo{constructor(e,t){this.seq=[],this.map={};const n=e.getProgramParameter(t,e.ACTIVE_UNIFORMS);for(let i=0;i<n;++i){const r=e.getActiveUniform(t,i),o=e.getUniformLocation(t,r.name);Zy(r,o,this)}}setValue(e,t,n,i){const r=this.map[t];r!==void 0&&r.setValue(e,n,i)}setOptional(e,t,n){const i=t[n];i!==void 0&&this.setValue(e,n,i)}static upload(e,t,n,i){for(let r=0,o=t.length;r!==o;++r){const a=t[r],l=n[a.id];l.needsUpdate!==!1&&a.setValue(e,l.value,i)}}static seqWithValue(e,t){const n=[];for(let i=0,r=e.length;i!==r;++i){const o=e[i];o.id in t&&n.push(o)}return n}}function vu(s,e,t){const n=s.createShader(e);return s.shaderSource(n,t),s.compileShader(n),n}const Qy=37297;let ev=0;function tv(s,e){const t=s.split(`
`),n=[],i=Math.max(e-6,0),r=Math.min(e+6,t.length);for(let o=i;o<r;o++){const a=o+1;n.push(`${a===e?">":" "} ${a}: ${t[o]}`)}return n.join(`
`)}function nv(s){const e=xt.getPrimaries(xt.workingColorSpace),t=xt.getPrimaries(s);let n;switch(e===t?n="":e===oa&&t===ra?n="LinearDisplayP3ToLinearSRGB":e===ra&&t===oa&&(n="LinearSRGBToLinearDisplayP3"),s){case Yt:case _a:return[n,"LinearTransferOETF"];case Ot:case cc:return[n,"sRGBTransferOETF"];default:return console.warn("THREE.WebGLProgram: Unsupported color space:",s),[n,"LinearTransferOETF"]}}function xu(s,e,t){const n=s.getShaderParameter(e,s.COMPILE_STATUS),i=s.getShaderInfoLog(e).trim();if(n&&i==="")return"";const r=/ERROR: 0:(\d+)/.exec(i);if(r){const o=parseInt(r[1]);return t.toUpperCase()+`

`+i+`

`+tv(s.getShaderSource(e),o)}else return i}function iv(s,e){const t=nv(e);return`vec4 ${s}( vec4 value ) { return ${t[0]}( ${t[1]}( value ) ); }`}function sv(s,e){let t;switch(e){case Jp:t="Linear";break;case Zp:t="Reinhard";break;case Qp:t="OptimizedCineon";break;case em:t="ACESFilmic";break;case nm:t="AgX";break;case im:t="Neutral";break;case tm:t="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",e),t="Linear"}return"vec3 "+s+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}function rv(s){return[s.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":"",s.extensionMultiDraw?"#extension GL_ANGLE_multi_draw : require":""].filter(Ar).join(`
`)}function ov(s){const e=[];for(const t in s){const n=s[t];n!==!1&&e.push("#define "+t+" "+n)}return e.join(`
`)}function av(s,e){const t={},n=s.getProgramParameter(e,s.ACTIVE_ATTRIBUTES);for(let i=0;i<n;i++){const r=s.getActiveAttrib(e,i),o=r.name;let a=1;r.type===s.FLOAT_MAT2&&(a=2),r.type===s.FLOAT_MAT3&&(a=3),r.type===s.FLOAT_MAT4&&(a=4),t[o]={type:r.type,location:s.getAttribLocation(e,o),locationSize:a}}return t}function Ar(s){return s!==""}function bu(s,e){const t=e.numSpotLightShadows+e.numSpotLightMaps-e.numSpotLightShadowsWithMaps;return s.replace(/NUM_DIR_LIGHTS/g,e.numDirLights).replace(/NUM_SPOT_LIGHTS/g,e.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,e.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,t).replace(/NUM_RECT_AREA_LIGHTS/g,e.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,e.numPointLights).replace(/NUM_HEMI_LIGHTS/g,e.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,e.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,e.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,e.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,e.numPointLightShadows)}function Eu(s,e){return s.replace(/NUM_CLIPPING_PLANES/g,e.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,e.numClippingPlanes-e.numClipIntersection)}const lv=/^[ \t]*#include +<([\w\d./]+)>/gm;function jl(s){return s.replace(lv,hv)}const cv=new Map;function hv(s,e){let t=ht[e];if(t===void 0){const n=cv.get(e);if(n!==void 0)t=ht[n],console.warn('THREE.WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',e,n);else throw new Error("Can not resolve #include <"+e+">")}return jl(t)}const uv=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function Mu(s){return s.replace(uv,dv)}function dv(s,e,t,n){let i="";for(let r=parseInt(e);r<parseInt(t);r++)i+=n.replace(/\[\s*i\s*\]/g,"[ "+r+" ]").replace(/UNROLLED_LOOP_INDEX/g,r);return i}function Su(s){let e=`precision ${s.precision} float;
...
#define LOW_PRECISION`),e}function fv(s){let e="SHADOWMAP_TYPE_BASIC";return s.shadowMapType===Gd?e="SHADOWMAP_TYPE_PCF":s.shadowMapType===Wd?e="SHADOWMAP_TYPE_PCF_SOFT":s.shadowMapType===li&&(e="SHADOWMAP_TYPE_VSM"),e}function pv(s){let e="ENVMAP_TYPE_CUBE";if(s.envMap)switch(s.envMapMode){case Ys:case Ks:e="ENVMAP_TYPE_CUBE";break;case pa:e="ENVMAP_TYPE_CUBE_UV";break}return e}function mv(s){let e="ENVMAP_MODE_REFLECTION";if(s.envMap)switch(s.envMapMode){case Ks:e="ENVMAP_MODE_REFRACTION";break}return e}function gv(s){let e="ENVMAP_BLENDING_NONE";if(s.envMap)switch(s.combine){case fa:e="ENVMAP_BLENDING_MULTIPLY";break;case Yp:e="ENVMAP_BLENDING_MIX";break;case Kp:e="ENVMAP_BLENDING_ADD";break}return e}function _v(s){const e=s.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),112)),texelHeight:n,maxMip:t}}function yv(s,e,t,n){const i=s.getContext(),r=t.defines;let o=t.vertexShader,a=t.fragmentShader;const l=fv(t),c=pv(t),h=mv(t),u=gv(t),d=_v(t),f=rv(t),g=ov(r),_=i.createProgram();let p,m,w=t.glslVersion?"#version "+t.glslVersion+`
...
`)+`
`+m);const v=w+p+o,S=w+m+a,I=vu(i,i.VERTEX_SHADER,v),P=vu(i,i.FRAGMENT_SHADER,S);i.attachShader(_,I),i.attachShader(_,P),t.index0AttributeName!==void 0?i.bindAttribLocation(_,0,t.index0AttributeName):t.morphTargets===!0&&i.bindAttribLocation(_,0,"position"),i.linkProgram(_);function C(U){if(s.debug.checkShaderErrors){const z=i.getProgramInfoLog(_).trim(),F=i.getShaderInfoLog(I).trim(),H=i.getShaderInfoLog(P).trim();let Z=!0,B=!0;if(i.getProgramParameter(_,i.LINK_STATUS)===!1)if(Z=!1,typeof s.debug.onShaderError=="function")s.debug.onShaderError(i,_,I,P);else{const he=xu(i,I,"vertex"),G=xu(i,P,"fragment");console.error("THREE.WebGLProgram: Shader Error "+i.getError()+" - VALIDATE_STATUS "+i.getProgramParameter(_,i.VALIDATE_STATUS)+`
...
`).length,n=e.length>_d?e.slice(0,_d)+`
...
`)}function yE(s){const e=s.getAttribute("position"),t=s.getIndex(),n=[];for(let l=0;l<e.count;l++)n.push([e.getX(l),e.getY(l),e.getZ(l)]);const i=[];if(t)for(let l=0;l<t.count;l+=3)i.push([t.getX(l),t.getX(l+1),t.getX(l+2)]);else for(let l=0;l<e.count;l+=3)i.push([l,l+1,l+2]);const r=new ArrayBuffer(84+i.length*50),o=new DataView(r);o.setUint32(80,i.length,!0);let a=84;for(const[l,c,h]of i){const u=n[l],d=n[c],f=n[h],g=d[0]-u[0],_=d[1]-u[1],p=d[2]-u[2],m=f[0]-u[0],w=f[1]-u[1],v=f[2]-u[2],S=_*v-p*w,I=p*m-g*v,P=g*w-_*m,C=Math.sqrt(S*S+I*I+P*P)||1;o.setFloat32(a,S/C,!0),a+=4,o.setFloat32(a,I/C,!0),a+=4,o.setFloat32(a,P/C,!0),a+=4;for(const D of[u,d,f])o.setFloat32(a,D[0],!0),a+=4,o.setFloat32(a,D[1],!0),a+=4,o.setFloat32(a,D[2],!0),a+=4;o.setUint16(a,0,!0),a+=2}return r}const ns={thickness:.003,bodyHalfWidth:.062,rearHalfWidth:.095};function Rl(s){const e=Math.max(.001,Math.min(.01,s.thickness)),t=Math.max(.04,Math.min(.09,s.bodyHalfWidth)),n=Math.max(t+.01,Math.min(.13,s.rearHalfWidth)),i=.115,r=.01,o=.08,a=-.145,l=t;function c(w,v,S,I,P=8e-4){const C=new Ir;return C.moveTo(w-S/2+P,v-I/2),C.lineTo(w+S/2-P,v-I/2),C.quadraticCurveTo(w+S/2,v-I/2,w+S/2,v-I/2+P),C.lineTo(w+S/2,v+I/2-P),C.quadraticCurveTo(w+S/2,v+I/2,w+S/2-P,v+I/2),C.lineTo(w-S/2+P,v+I/2),C.quadraticCurveTo(w-S/2,v+I/2,w-S/2,v+I/2-P),C.lineTo(w-S/2,v-I/2+P),C.quadraticCurveTo(w-S/2,v-I/2,w-S/2+P,v-I/2),C}function h(w,v,S){const I=new Ir;return I.absarc(w,v,S,0,Math.PI*2,!1),I}const u=new Cf;u.moveTo(-n+r,i),u.lineTo(n-r,i),u.quadraticCurveTo(n,i,n,i-r),u.lineTo(n,o),u.lineTo(t,o),u.lineTo(t,a+l),u.absarc(0,a+l,t,0,-Math.PI,!0),u.lineTo(-t,o),u.lineTo(-n,o),u.lineTo(-n,i-r),u.quadraticCurveTo(-n,i,-n+r,i);const d=n-.02;u.holes.push(c(-d,.093,.012,.014,.001)),u.holes.push(c(d,.093,.012,.014,.001));const f=new Ir,g=0,_=.05;f.moveTo(g-.025,_-.035),f.lineTo(g-.025,_-.018),f.lineTo(g-.033,_-.018),f.lineTo(g-.033,_+.002),f.lineTo(g-.025,_+.002),f.lineTo(g-.025,_+.018),f.lineTo(g-.015,_+.028),f.lineTo(g+.015,_+.028),f.lineTo(g+.025,_+.018),f.lineTo(g+.025,_+.002),f.lineTo(g+.033,_+.002),f.lineTo(g+.033,_-.018),f.lineTo(g+.025,_-.018),f.lineTo(g+.025,_-.035),f.lineTo(g-.025,_-.035),u.holes.push(f),u.holes.push(c(-.025,.098,.018,.006,.001)),u.holes.push(c(.025,.098,.018,.006,.001)),u.holes.push(c(0,.09,.014,.004,.001)),u.holes.push(c(-.025,-.085,.018,.004,.001)),u.holes.push(c(.025,-.085,.018,.004,.001)),u.holes.push(h(0,-.098,.006));const p=.002;u.holes.push(h(-.08,.105,p)),u.holes.push(h(.08,.105,p)),u.holes.push(h(-.08,.083,p)),u.holes.push(h(.08,.083,p)),u.holes.push(h(-.02,.108,p)),u.holes.push(h(.02,.108,p)),u.holes.push(h(-.048,.01,p)),u.holes.push(h(.048,.01,p)),u.holes.push(h(-.048,-.03,p)),u.holes.push(h(.048,-.03,p)),u.holes.push(h(0,-.02,p)),u.holes.push(h(-.014,-.065,p)),u.holes.push(h(.014,-.065,p)),u.holes.push(h(-.014,-.052,p)),u.holes.push(h(.014,-.052,p)),u.holes.push(h(-.04,-.062,p)),u.holes.push(h(.04,-.062,p));const m=new bc(u,{depth:e,bevelEnabled:!1,curveSegments:48});return m.rotateZ(-Math.PI/2),yE(m)}const Ti={radius:.0325,width:.026};function Ll(s){const e=Math.max(.02,Math.min(.05,s.radius)),t=e*(31/32.5),n=Math.max(.008,Math.min(.03,s.width)),i=64,r=16,o=4,a=.58,l=.62,c=[],h=(w,v,S)=>c.push(...w,...v,...S),u=(w,v,S,I)=>{h(w,v,S),h(w,S,I)};for(let w=0;w<i;w++){const v=2*Math.PI*w/i,S=2*Math.PI*(w+1)/i,I=Math.cos(v),P=Math.sin(v),C=Math.cos(S),D=Math.sin(S),E=[t*I,t*P,-n/2],y=[t*C,t*D,-n/2],U=[t*I,t*P,n/2],z=[t*C,t*D,n/2];u(E,y,z,U),h([0,0,-n/2],y,E),h([0,0,n/2],U,z)}const d=2*Math.PI/r,f=n/o;for(let w=0;w<r;w++){const v=d*(w+.5),S=v-d*a/2,I=v+d*a/2;for(let P=0;P<o;P++){const C=-n/2+f*(P+.5),D=C-f*l/2,E=C+f*l/2,[y,U,z,F]=[Math.cos(S),Math.sin(S),Math.cos(I),Math.sin(I)],H=[t*y,t*U,D],Z=[t*z,t*F,D],B=[t*y,t*U,E],he=[t*z,t*F,E],G=[e*y,e*U,D],se=[e*z,e*F,D],ae=[e*y,e*U,E],me=[e*z,e*F,E];u(G,se,me,ae),u(H,G,ae,B),u(Z,he,me,se),u(H,Z,se,G),u(ae,me,he,B)}}const g=c.length/9,_=new ArrayBuffer(84+g*50),p=new DataView(_);p.setUint32(80,g,!0);let m=84;for(let w=0;w<g;w++){const v=w*9,S=c[v+3]-c[v],I=c[v+4]-c[v+1],P=c[v+5]-c[v+2],C=c[v+6]-c[v],D=c[v+7]-c[v+1],E=c[v+8]-c[v+2],y=I*E-P*D,U=P*C-S*E,z=S*D-I*C,F=Math.sqrt(y*y+U*U+z*z)||1;p.setFloat32(m,y/F,!0),m+=4,p.setFloat32(m,U/F,!0),m+=4,p.setFloat32(m,z/F,!0),m+=4;for(let H=0;H<9;H++)p.setFloat32(m,c[v+H],!0),m+=4;p.setUint16(m,0,!0),m+=2}return _}const Ri=[{id:"hcsr04",label:"HC-SR04",category:"Sensor",description:"Ultrasonic distance sensor",defaultDims:[.045,.02,.015],cssColor:"#3373e5",urdfRgba:"0.20 0.45 0.90 1.00",defaultZ:.015,factory:()=>Cn(()=>import("./generators-DXlbW-jJ.js"),[]).then(s=>({generate:s.generateHcsr04}))},{id:"l298n",label:"L298N",category:"Actuator",description:"Dual H-bridge motor driver",defaultDims:[.043,.043,.02],cssColor:"#c01f1f",urdfRgba:"0.75 0.12 0.12 1.00",defaultZ:.005,factory:()=>Cn(()=>import("./generators-DXlbW-jJ.js"),[]).then(s=>({generate:s.generateL298n}))},{id:"esp32cam_lib",label:"ESP32-CAM",category:"MCU",description:"ESP32 camera module",defaultDims:[.0405,.027,.013],cssColor:"#1a7a3c",urdfRgba:"0.00 0.45 0.20 1.00",defaultZ:.005,factory:()=>Cn(()=>import("./generators-DXlbW-jJ.js"),[]).then(s=>({generate:s.generateEsp32Cam}))},{id:"tt_motor",label:"TT Motor",category:"Actuator",description:"TT gear motor with DC can",defaultDims:[.036,.018,.022],cssColor:"#c89a14",urdfRgba:"0.83 0.63 0.09 1.00",defaultZ:.011,factory:()=>Cn(()=>import("./generators-DXlbW-jJ.js"),[]).then(s=>({generate:s.generateTtMotor}))},{id:"sg90",label:"SG90",category:"Actuator",description:"Micro servo motor",defaultDims:[.022,.0115,.023],cssColor:"#e07810",urdfRgba:"0.90 0.50 0.15 1.00",defaultZ:.012,factory:()=>Cn(()=>import("./generators-DXlbW-jJ.js"),[]).then(s=>({generate:s.generateSg90}))},{id:"arduino_nano",label:"Arduino Nano",category:"MCU",description:"Arduino Nano microcontroller",defaultDims:[.043,.018,.01],cssColor:"#006e33",urdfRgba:"0.00 0.50 0.30 1.00",defaultZ:.005,factory:()=>Cn(()=>import("./generators-DXlbW-jJ.js"),[]).then(s=>({generate:s.generateArduinoNano}))},{id:"mpu6050",label:"MPU-6050",category:"Sensor",description:"6-axis IMU (accelerometer + gyroscope)",defaultDims:[.02,.02,.0025],cssColor:"#7a52cc",urdfRgba:"0.55 0.35 0.80 1.00",defaultZ:.005,factory:()=>Cn(()=>import("./generators-DXlbW-jJ.js"),[]).then(s=>({generate:s.generateMpu6050}))}],vE=Object.fromEntries(Ri.map(s=>[s.id,{label:s.label,color:s.urdfRgba,defaultZ:s.defaultZ,geomType:"mesh",defaultDims:[...s.defaultDims],category:s.category,cssColor:s.cssColor}])),Un={ultrasonic:{label:"Ultrasonic",color:"0.20 0.45 0.90 1.00",defaultZ:.015,geomType:"box",defaultDims:[.045,.02,.015],hidden:!0},camera:{label:"Camera",color:"0.90 0.20 0.25 1.00",defaultZ:.01,geomType:"box",defaultDims:[.025,.024,.009]},lidar:{label:"LIDAR",color:"0.20 0.80 0.45 1.00",defaultZ:.035,geomType:"cylinder",defaultDims:[.035,.04]},imu:{label:"IMU",color:"0.55 0.35 0.80 1.00",defaultZ:.008,geomType:"box",defaultDims:[.02,.02,.008],hidden:!0},servo:{label:"Servo",color:"0.90 0.50 0.15 1.00",defaultZ:.02,geomType:"box",defaultDims:[.022,.012,.03],hidden:!0},arduino:{label:"Arduino",color:"0.00 0.45 0.20 1.00",defaultZ:.008,geomType:"box",defaultDims:[.044,.018,.008],hidden:!0},raspberry_pi:{label:"Raspberry Pi",color:"0.70 0.10 0.20 1.00",defaultZ:.017,geomType:"box",defaultDims:[.086,.056,.017]},gps:{label:"GPS",color:"0.20 0.70 0.35 1.00",defaultZ:.01,geomType:"box",defaultDims:[.025,.025,.01]},buck_converter:{label:"Buck Conv.",color:"0.85 0.60 0.00 1.00",defaultZ:.011,geomType:"box",defaultDims:[.023,.017,.011]},box:{label:"Box",color:"0.65 0.65 0.65 1.00",defaultZ:.02,geomType:"box",defaultDims:[.04,.04,.02]},...vE},xE=new Set(["robot-car"]),Ed=`<link name="wheel_left">
  <visual>
...
<joint name="wheel_right_joint" type="continuous">
  ...
  <axis xyz="0 0 1"/>
  <limit effort="2.0" velocity="15.0"/>
</joint>`,Md=`<joint name="chassis_joint" type="fixed">
  <parent link="base_link"/>
  <child link="chassis"/>
...
</link>`,Sd=`<link name="caster_plate">
  <visual>
...
</joint>`;function wd(s,e){const t=[...e.entries()].sort(([r],[o])=>r.localeCompare(o)),n=t.filter(([r])=>r.startsWith("00")).map(([,r])=>r.trimEnd()).join(`
...
`);i=l.pop();for(const c of l)if(c.startsWith("event: "))r=c.slice(7).trim();else if(c.startsWith("data: ")&&r){const h=c.slice(6);if(h==="[DONE]")return;try{yield{event:r,data:JSON.parse(h)}}catch{}r=null}}}async _processStream(e,t){const n=[],i=[],r=new Map;let o=null,a="",l=null,c="",h=!1,u=!1;const d=()=>{u||(u=!0,t.remove())};for await(const{event:f,data:g}of this._parseSSE(e)){const _=g;if(f==="content_block_start"){d();const p=_.content_block;(p==null?void 0:p.type)==="text"?(o=this._appendAssistantBubble(""),a="",n.push({type:"text",text:""})):(p==null?void 0:p.type)==="tool_use"&&(l={id:p.id,name:p.name,idx:n.length},c="",n.push({type:"tool_use",id:p.id,name:p.name,input:{}}),r.set(p.id,this._appendToolCard(p.name)))}else if(f==="content_block_delta"){const p=_.delta;if((p==null?void 0:p.type)==="text_delta"){a+=p.text??"";const m=n[n.length-1];(m==null?void 0:m.type)==="text"&&(m.text=a),o&&!h&&(h=!0,requestAnimationFrame(()=>{h=!1,o&&(o.innerHTML=qo(a),this._messagesEl.scrollTop=this._messagesEl.scrollHeight)}))}else(p==null?void 0:p.type)==="input_json_delta"&&(c+=p.partial_json??"")}else if(f==="content_block_stop"&&l){let p={};try{p=JSON.parse(c)}catch{}n[l.idx].input=p,i.push({type:"tool_use",id:l.id,name:l.name,input:p}),l=null}}return d(),{content:n,toolCalls:i,toolCards:r}}_clearChat(){this._history=[],this._messagesEl.innerHTML="",localStorage.removeItem("urdf-chat-history"),this._updateEmptyState()}_appendChat(e){this._messagesEl.appendChild(e),this._messagesEl.scrollTop=this._messagesEl.scrollHeight}_appendUserBubble(e){const t=document.createElement("div");t.className="chat-msg-user",t.textContent=e,this._appendChat(t)}_appendAssistantBubble(e){const t=document.createElement("div");return t.className="chat-msg-assistant",t.innerHTML=qo(e),this._appendChat(t),t}_appendSystemMsg(e){const t=document.createElement("div");t.className="chat-msg-system",t.textContent=e,this._appendChat(t)}_appendSpinner(){const e=document.createElement("div");return e.className="chat-spinner",e.innerHTML="<span></span><span></span><span></span>",this._appendChat(e),e}_appendToolCard(e){const t=document.createElement("details");t.className="chat-tool-card";const n=document.createElement("summary"),i=document.createElement("span");i.className="chat-tool-card-status";const r=document.createElement("span");r.className="chat-tool-card-name",r.textContent=e;const o=document.createElement("span");return o.className="chat-tool-card-subtitle",n.append(i,r,o),t.appendChild(n),this._appendChat(t),{setResult(a,l,c){i.textContent=a?"✓":"✕",i.classList.add(a?"ok":"err"),l&&Object.keys(l).length&&(o.textContent=Object.entries(l).slice(0,3).map(([d,f])=>`${d}=${typeof f=="number"?+Number(f).toFixed(3):f}`).join(" "));const h=document.createElement("div");h.className="chat-tool-card-body";const u=[];l&&Object.keys(l).length&&u.push(`<span class="j-dir">in</span>  ${Td(JSON.stringify(l))}`),u.push(`<span class="j-dir">out</span> ${Td(JSON.stringify(c))}`),h.innerHTML=u.join(`
`),t.appendChild(h)}}}appendRecapCard(e,t){if(!t.length)return;const n=document.createElement("div");n.className="chat-recap-card";const i=document.createElement("div");i.className="chat-recap-card-title",i.textContent=`${e} adjusted`,n.appendChild(i);for(const r of t){const o=document.createElement("div");o.className="chat-recap-card-row";const a=document.createElement("span");a.textContent=r.label;const l=document.createElement("span");l.textContent=`${+r.from.toFixed(1)} → ${+r.to.toFixed(1)} ${r.unit}`,o.append(a,l),n.appendChild(o)}this._appendChat(n)}_appendActionCard(e,t){const n=document.createElement("div");n.className="chat-action-card";const i=document.createElement("div");i.className="chat-action-card-title",i.textContent=ME[e]??e;const r=document.createElement("div");r.className="chat-action-card-msg",r.textContent=t;const o=document.createElement("div");o.className="chat-action-card-footer";const a=document.createElement("button");a.type="button",a.className="chat-action-btn primary",a.textContent="Open Panel",a.addEventListener("click",()=>{this._cb.openPanel(e),n.remove()});const l=document.createElement("button");l.type="button",l.className="chat-action-btn",l.textContent="Dismiss",l.addEventListener("click",()=>n.remove()),o.append(a,l),n.append(i,r,o),this._appendChat(n)}}let Ki=null;async function AE(){if(Ki)return Ki;const{default:s}=await Cn(async()=>{const{default:e}=await import("https://cdn.jsdelivr.net/npm/mujoco-js@0.0.7/dist/mujoco_wasm.js");return{default:e}},[]);return Ki=await s(),Ki.FS.mkdir("/working"),Ki.FS.mount(Ki.MEMFS,{root:"."},"/working"),Ki}class CE{constructor(){this._model=null,this._data=null,this._raf=0,this._mj=null}_resolve(e,t,n){if(!e.startsWith("package://"))return e.startsWith("/")||e.startsWith("http")?e:n+e;const[i,r]=e.slice(10).split(/\/(.+)/);for(const o of t.split(";")){const[a,l]=o.split(":").map(c=>c.trim());if(a===i)return`${l}/${r}`}return null}_prepareUrdf(e,t){let n=e.replace(/<visual[\s\S]*?<\/visual>/g,"");for(const[i,r]of t)n=n.replaceAll(`"${i}"`,`"/working/${r}"`);return n}async load(e,t){var l,c,h,u;this.stop();const n=await AE();this._mj=n;const i=await fetch(e).then(d=>d.text()),r=e.replace(/[^/]+$/,""),o=new Map;let a=0;for(const d of i.matchAll(/<collision[\s\S]*?<\/collision>/g)){const f=(l=d[0].match(/filename="([^"]+)"/))==null?void 0:l[1];if(!f)continue;const g=((c=f.split(".").pop())==null?void 0:c.toLowerCase())??"";g!=="stl"&&g!=="obj"||o.has(f)||o.set(f,`col_${a++}.stl`)}for(const[d,f]of o){const g=this._resolve(d,t,r);if(g)try{const _=await fetch(g).then(p=>p.arrayBuffer());n.FS.writeFile(`/working/${f}`,new Uint8Array(_))}catch{}}n.FS.writeFile("/working/model.xml",this._prepareUrdf(i,o)),(h=this._model)==null||h.delete(),(u=this._data)==null||u.delete(),this._model=n.MjModel.loadFromXML("/working/model.xml"),this._data=new n.MjData(this._model)}start(e,t){if(!this._model||!this._data||!this._mj)return;const{_mj:n,_model:i,_data:r}=this,o=()=>{this._raf=requestAnimationFrame(o),n.mj_step(i,r);for(let a=0;a<i.njnt;a++){const l=i.jnt_type[a];if(l!==2&&l!==3)continue;const c=n.mj_id2name(i,n.mjtObj.mjOBJ_JOINT.value,a);c&&e.joints[c]&&e.setJointValue(c,r.qpos[i.jnt_qposadr[a]])}t()};o()}stop(){var e,t;cancelAnimationFrame(this._raf),this._raf=0,(e=this._model)==null||e.delete(),this._model=null,(t=this._data)==null||t.delete(),this._data=null}}function xe(s){return document.getElementById(s)}customElements.define("urdf-viewer",hE);const ea=new CE;let Wf="",jf="";const Ue=xe("viewer"),ls=xe("joints"),Bi=xe("robots"),Pc=xe("loading"),jr=xe("part-label"),Il=xe("gesture-toggle"),RE=xe("gesture-overlay"),LE=xe("gesture-video"),Xf=xe("gesture-section"),Xr=xe("gesture-section-header"),PE=xe("editor-panel"),NE=xe("build-notice"),fn=new tc(Ue,PE),ie=new Sa(Ue,NE);let cn;const mi=new hb(.5,25,5592405,3355443);mi.visible=!1;mi.raycast=()=>{};requestAnimationFrame(()=>Ue.scene.add(mi));const qf=xe("chat-input");xe("tab-robot").addEventListener("click",()=>{fn.close(),ie.close(),document.body.classList.remove("library-open"),mi.visible=!1});xe("tab-editor").addEventListener("click",()=>{ie.close(),document.body.classList.remove("library-open"),fn.open(),mi.visible=!1,qf.placeholder="Ask AI to edit this URDF…"});xe("tab-build").addEventListener("click",()=>{fn.close(),document.body.classList.remove("library-open"),ie.open(),mi.visible=!0,mi.position.y=Ue.shadowPlane.position.y,qf.placeholder="Ask AI to add or modify components…"});xe("tab-library").addEventListener("click",()=>{fn.close(),ie.close(),mi.visible=!1,document.body.classList.add("library-open"),Zc()});const Ad=xe("ignore-limits"),Cd=xe("show-collision"),nc=xe("display-shadow"),ha=xe("up-axis"),Us=xe("btn-simulate"),Cr=xe("simulate-status");function IE(s){return{id:s.id,name:s.name,label:s.label,up:s.up,...s.parts?{parts:`/robots/${s.parts}`}:{},...s.urdf?{urdf:`/robots/${s.urdf}`}:{},...s.package?{package:`${s.package}: /robots/${s.id}`}:{}}}function DE(s,e){const t=[...e.entries()].sort(([r],[o])=>r.localeCompare(o)),n=t.filter(([r])=>r.startsWith("00")).map(([,r])=>r.trimEnd()).join(`
`),i=t.filter(([r])=>!r.startsWith("00")).map(([,r])=>r.trimEnd()).join(`
...
`}let $o=null;async function UE(s){const e=s.parts,t=await fetch(`${e}.parts.json`).then(a=>a.json()),n=e.replace(/\/[^/]+$/,""),i=t.contents?new Map(t.parts.map(a=>[a,t.contents[a]])):new Map(await Promise.all(t.parts.map(async a=>[a,await fetch(`${n}/parts/${a}`).then(l=>l.text())])));ie.init(t.robot,n,i);const r=DE(t.robot,i).replace(/filename="([^/"]+)"/g,`filename="${n}/$1"`);$o&&URL.revokeObjectURL($o),$o=URL.createObjectURL(new Blob([r],{type:"application/xml"})),Ue.urdf=$o,to();const o=ie.restore();for(const{id:a,type:l}of o){const c=Un[l];if((c==null?void 0:c.geomType)==="mesh"){const h=Ri.find(u=>u.id===l);h&&h.factory().then(({generate:u})=>ie.restoreMeshBlob(a,u())).catch(u=>console.warn("[restore] mesh regen failed for",a,u))}ds(a,l)}o.length>0&&us(),On(),nr()}let ui=[],$f=0;const zs=xe("robot-track-slider");function wa(s){const e=Bi.getBoundingClientRect(),t=s.getBoundingClientRect();zs.style.width=`${t.width}px`,zs.style.height=`${t.height}px`,zs.style.left=`${t.left-e.left}px`,zs.style.top=`${t.top-e.top}px`}function Ur(){const s=Bi.querySelector(".robot-btn.active");s&&wa(s)}function OE(){for(const s of Bi.querySelectorAll(".robot-btn"))s.classList.remove("active")}function qr(s,e){$f=e,Ue.up=s.up,ha.value=s.up,Ue.package=s.package??"",ea.stop(),document.body.classList.remove("simulating"),Us.textContent="Simulate",Cr.textContent="",Wf=s.urdf??"",jf=s.package??"",xe("simulate-bar").hidden=!s.urdf;const t=s.parts?`${s.parts}.urdf`:s.urdf;s.parts?UE(s).catch(()=>{}):Ue.urdf=s.urdf,OE();const n=s.name?Bi.querySelector(`.robot-btn[data-name="${s.name}"]`):null;n&&(n.classList.add("active"),wa(n)),fn.setSourceUrl(t),fn.loadPartsInBackground()}let vn=null,Mr=null;function FE(s){Bi.querySelectorAll(".robot-btn").forEach(e=>e.remove());for(let e=0;e<s.length;e++){const t=s[e],n=document.createElement("button");n.type="button",n.className="robot-btn",n.textContent=t.label,n.title=t.name,n.dataset.name=t.name,n.dataset.index=String(e),n.addEventListener("click",()=>qr(t,e)),n.addEventListener("mouseenter",()=>{wa(n),vn&&clearTimeout(vn),vn=setTimeout(()=>qr(t,e),150)}),Bi.appendChild(n)}}Bi.closest(".robot-shell").addEventListener("mouseleave",()=>{vn&&(clearTimeout(vn),vn=null),Ur()});new ResizeObserver(Ur).observe(Bi);zs.style.transition="none";fetch("/robots/catalog.json").then(s=>s.ok?s.json():Promise.reject()).then(s=>{ui=s.robots.map(IE)}).catch(()=>{ui=[{id:"robot-car",name:"Robot Car",label:"Car",parts:"/robots/robot-car/robot-car",up:"+Z"},{id:"T12",name:"T12",label:"T12",urdf:"/robots/T12/urdf/T12.URDF",up:"-Z"},{id:"TriATHLETE",name:"TriATHLETE",label:"Tri",urdf:"/robots/TriATHLETE/urdf/TriATHLETE.URDF",up:"-Z"},{id:"laikago",name:"Laikago",label:"Laikago",urdf:"/robots/laikago/urdf/laikago.urdf",up:"+Z"},{id:"open_manipulator_x",name:"Open Manipulator X",label:"OM-X",urdf:"/robots/open_manipulator_x/open_manipulator_x.urdf",package:"open_manipulator_description: /robots/open_manipulator_x",up:"+Z"},{id:"so_arm100",name:"SO-ARM100",label:"SO-100",urdf:"/robots/so_arm100/so100.urdf",up:"+Z"},{id:"simple_humanoid",name:"Simple Humanoid",label:"Humanoid",urdf:"/robots/simple_humanoid/simple_humanoid.urdf",up:"+Z"},{id:"spryped",name:"Spryped",label:"Spryped",urdf:"/robots/spryped/urdf/spryped.urdf",package:"spryped_urdf_rev06: /robots/spryped",up:"+Z"}]}).finally(()=>{FE(ui);const s=new URLSearchParams(location.search).get("robot"),e=s?Math.max(0,ui.findIndex(t=>t.id===s)):0;qr(ui[e],e),requestAnimationFrame(()=>requestAnimationFrame(()=>{zs.style.transition=""}))});document.addEventListener("keydown",s=>{if(s.key!=="ArrowLeft"&&s.key!=="ArrowRight")return;const e=document.activeElement;if(e.tagName==="INPUT"||e.tagName==="TEXTAREA"||e.isContentEditable)return;const t=s.key==="ArrowRight"?1:-1,n=($f+t+ui.length)%ui.length;qr(ui[n],n)});Ad.addEventListener("change",()=>{Ue.ignoreLimits=Ad.checked});Cd.addEventListener("change",()=>{Ue.showCollision=Cd.checked});nc.addEventListener("change",()=>{Ue.displayShadow=nc.checked});ha.addEventListener("change",()=>{Ue.up=ha.value});Us.addEventListener("click",async()=>{if(document.body.classList.contains("simulating")){ea.stop(),document.body.classList.remove("simulating"),Us.textContent="Simulate",Cr.textContent="";return}Us.disabled=!0,Cr.textContent="Loading physics…";try{await ea.load(Wf,jf),ea.start(Ue.robot,()=>Ue.redraw()),document.body.classList.add("simulating"),Us.textContent="Stop",Cr.textContent=""}catch(s){Cr.textContent="Failed",console.error("[simulator]",s)}finally{Us.disabled=!1}});nc.checked=Ue.displayShadow;ha.value=Ue.up;function ic(s){return s.replace(/_joint$/,"").replace(/_/g," ").replace(/\b\w/g,e=>e.toUpperCase())}function Yf(s){return s.replace(/_joint$/,"")}const Rd=xe("inspector"),kE=xe("inspector-name"),Nc=xe("inspector-x"),Ic=xe("inspector-y"),Dc=xe("inspector-z"),Ta=xe("inspector-scale-x"),Aa=xe("inspector-scale-y"),Ca=xe("inspector-scale-z"),Kf=xe("inspector-snippet"),Dl=xe("inspector-copy"),BE=xe("inspector-close");let rs=null,Or=null,sn=null;function hi(s){return s.toFixed(4)}function Jf(){if(!rs||!Ue.robot)return;const s=Ue.robot.joints[rs];if(!s)return;const e=s.position,t=s.rotation,n=parseFloat(Ta.value),i=parseFloat(Aa.value),r=parseFloat(Ca.value),o=Math.abs(n-1)>.005||Math.abs(i-1)>.005||Math.abs(r-1)>.005,a=Math.abs(n-i)<.001&&Math.abs(i-r)<.001;let l="";o&&a?l=`
scale: ${n.toFixed(2)}×`:o&&(l=`
scale: ${n.toFixed(2)} ${i.toFixed(2)} ${r.toFixed(2)}`),Kf.textContent=`[${rs}]
<origin xyz="${hi(e.x)} ${hi(e.y)} ${hi(e.z)}"
        rpy="${hi(t.x)} ${hi(t.y)} ${hi(t.z)}"/>${l}`}let Ld=0;function zE(){if(!rs||!Ue.robot)return;const s=Ue.robot.joints[rs];if(!s)return;s.position.set(parseFloat(Nc.value)||0,parseFloat(Ic.value)||0,parseFloat(Dc.value)||0);const e=parseFloat(Ta.value)||1,t=parseFloat(Aa.value)||1,n=parseFloat(Ca.value)||1,i=Ue.robot.links[Yf(rs)];i&&i.scale.set(e,t,n),Ue.redraw(),clearTimeout(Ld),Ld=window.setTimeout(Jf,150)}function Qr(s){var i;rs=s;const e=s?(i=Ue.robot)==null?void 0:i.joints[s]:null;if(!e){Rd.style.display="none",Ii&&(Ii=null,ua(null));return}Rd.style.display="",kE.textContent=ic(s);const t=e.position;Nc.value=hi(t.x),Ic.value=hi(t.y),Dc.value=hi(t.z);const n=Ue.robot.links[Yf(s)];if(Ta.value=String(n?n.scale.x:1),Aa.value=String(n?n.scale.y:1),Ca.value=String(n?n.scale.z:1),Jf(),sn==null||sn.setSelectedJoint(s),document.querySelectorAll(".fp-gesture-active").forEach(r=>r.classList.remove("fp-gesture-active")),document.body.classList.contains("build-open")){const r=s.endsWith("_joint")?s.slice(0,-6):s;if(!ie.componentIds.has(r)){kt=null,Ii=s;for(const o of Qn.querySelectorAll(".build-component"))o.classList.remove("selected");$c.hidden=!0,ua({label:ic(s),color:"var(--text-3)",onDismiss:()=>Qr(null)})}}}function Zf(s,e){let t=0,n=0,i=!1;const r=parseFloat(e.step)||.001;s.addEventListener("pointerdown",o=>{t=o.clientX,n=parseFloat(e.value)||0,i=!1,s.setPointerCapture(o.pointerId)}),s.addEventListener("pointermove",o=>{if(!s.hasPointerCapture(o.pointerId))return;const a=o.clientX-t;!i&&Math.abs(a)<3||(i=!0,e.value=String(parseFloat((n+a*r).toFixed(6))),e.dispatchEvent(new Event("input",{bubbles:!0})))}),s.addEventListener("pointerup",()=>{i||e.focus(),i=!1})}var Vd;for(const s of[Nc,Ic,Dc,Ta,Aa,Ca]){s.addEventListener("input",zE);const e=(Vd=s.closest(".inspector-row"))==null?void 0:Vd.querySelector("label");e&&Zf(e,s)}BE.addEventListener("click",()=>Qr(null));Dl.addEventListener("click",()=>{navigator.clipboard.writeText(Kf.textContent??""),Dl.textContent="Copied!",setTimeout(()=>{Dl.textContent="Copy"},1500)});Ue.addEventListener("click",()=>{Or&&(Qr(Or),fn.isOpen&&fn.jumpToJoint(Or))});const Uc=xe("urdf-error-banner"),HE=xe("urdf-error-text"),VE=xe("urdf-error-close");Ue.addEventListener("urdf-change",()=>{Pc.classList.add("visible"),ls.innerHTML="",Qr(null),Uc.classList.remove("visible")});Ue.addEventListener("urdf-error",s=>{Pc.classList.remove("visible"),HE.textContent=s.detail||"URDF load error",Uc.classList.add("visible")});VE.addEventListener("click",()=>{Uc.classList.remove("visible")});Ue.addEventListener("urdf-processed",()=>{Pc.classList.remove("visible"),document.querySelectorAll('input[data-preview="true"]').forEach(s=>{s.value="0"}),requestAnimationFrame(()=>{mi.position.y=Ue.shadowPlane.position.y})});const Pd=Math.PI/180;let Sr=null;function GE(){Sr==null||Sr.abort(),Sr=new AbortController;const{signal:s}=Sr;if(ls.innerHTML="",!Ue.robot)return;const e=Object.values(Ue.robot.joints).filter(t=>t.jointType!=="fixed"&&t.visible).sort((t,n)=>t.name.localeCompare(n.name));for(const t of e){const n=document.createElement("div");n.className="joint",n.dataset.joint=t.name;const i=document.createElement("div");i.className="joint-name",i.title=t.name,i.textContent=t.name;const r=document.createElement("div");r.className="joint-row";const o=document.createElement("input");o.type="range",o.step="0.001";const a=document.createElement("input");a.type="number",a.step="0.001";const l=t.jointType==="prismatic",c=l?1:1/Pd;n.update=()=>{const h=t.jointType==="continuous",u=Ue.ignoreLimits||h?-6.28:t.limit.lower,d=Ue.ignoreLimits||h?6.28:t.limit.upper;o.min=String(u),o.max=String(d),o.value=String(t.angle),a.min=String(+(u*c).toFixed(3)),a.max=String(+(d*c).toFixed(3)),a.value=String(+(t.angle*c).toPrecision(4))},o.addEventListener("input",()=>{Ue.setJointValue(t.name,parseFloat(o.value))},{signal:s}),a.addEventListener("change",()=>{const h=l?1:Pd;Ue.setJointValue(t.name,parseFloat(a.value)*h)},{signal:s}),r.append(o,a),n.append(i,r),ls.appendChild(n),n.update()}}Ue.addEventListener("urdf-processed",GE);Ue.addEventListener("ignore-limits-change",()=>{var s;for(const e of ls.querySelectorAll(".joint"))(s=e.update)==null||s.call(e)});Ue.addEventListener("angle-change",s=>{var t,n;const e=s.detail;(n=(t=ls.querySelector(`[data-joint="${e}"]`))==null?void 0:t.update)==null||n.call(t)});let Nd=0;Ue.addEventListener("pointermove",s=>{cancelAnimationFrame(Nd),Nd=requestAnimationFrame(()=>{jr.style.left=s.clientX+14+"px",jr.style.top=s.clientY-32+"px"})});Ue.addEventListener("joint-mouseover",s=>{var t;const e=s.detail;Or=e,(t=ls.querySelector(`[data-joint="${e}"]`))==null||t.setAttribute("data-hovered",""),jr.textContent=ic(e),jr.style.display="block"});Ue.addEventListener("joint-mouseout",s=>{var t;const e=s.detail;Or=null,(t=ls.querySelector(`[data-joint="${e}"]`))==null||t.removeAttribute("data-hovered"),jr.style.display="none"});function WE(s,e){var r,o;const t=(r=document.elementFromPoint(s,e))==null?void 0:r.closest(".robot-btn");if(t){t.click();return}const n=(o=document.elementFromPoint(s,e))==null?void 0:o.closest("[data-fp-row-index]");if(n&&sn&&$s){const a=Yc[$s],l=parseInt(n.dataset.fpRowIndex,10),c=a==null?void 0:a.rows[l];if(c){document.querySelectorAll(".fp-gesture-active").forEach(h=>h.classList.remove("fp-gesture-active")),n.classList.add("fp-gesture-active"),sn.setParamCallback(h=>{const u=Math.max(c.min,Math.min(c.max,c.get()+h*15));c.set(u),us()});return}}const i={clientX:s,clientY:e,bubbles:!0,pointerId:1};Ue.dispatchEvent(new PointerEvent("pointerdown",i)),Ue.dispatchEvent(new PointerEvent("pointerup",i))}Il.addEventListener("click",async()=>{if(sn){sn.stop();return}const{GestureController:s}=await Cn(async()=>{const{GestureController:e}=await import("./gesture-BLOPomlg.js");return{GestureController:e}},[]);sn=new s({viewer:Ue,overlayCanvas:RE,videoEl:LE,onDwellSelect:WE,onPointerMove(e,t){var i;const n=(i=document.elementFromPoint(e,t))==null?void 0:i.closest(".robot-btn");if(n){if(wa(n),n!==Mr){Mr=n,vn&&clearTimeout(vn);const r=parseInt(n.dataset.index,10);vn=setTimeout(()=>qr(ui[r],r),150)}}else Mr&&(Mr=null,vn&&(clearTimeout(vn),vn=null)),Ur()},onPointerLeave(){Mr=null,Ur()},onThumbsUp(){cn==null||cn.resumeFromGesture()},onStop(){sn=null,Il.classList.remove("active"),Ur()}}),sn.start().then(()=>{Il.classList.add("active"),Xf.classList.add("open"),Xr.setAttribute("aria-expanded","true")}).catch(()=>{sn=null})});Xr.addEventListener("click",()=>{const s=Xf.classList.toggle("open");Xr.setAttribute("aria-expanded",String(s))});Xr.addEventListener("keydown",s=>{(s.key==="Enter"||s.key===" ")&&(s.preventDefault(),Xr.click())});function jE(s,e,t){s.addEventListener("input",()=>{e.value=s.value,t()}),e.addEventListener("change",()=>{const n=Math.max(parseFloat(e.min),Math.min(parseFloat(e.max),parseFloat(e.value)));s.value=String(n),e.value=String(n),t()})}const Oc=xe("build-chassis-thickness"),Fc=xe("build-chassis-body-hw"),kc=xe("build-chassis-rear-hw"),Bc=xe("build-wheel-radius"),zc=xe("build-wheel-width"),Hc=xe("build-caster-radius"),Vc=xe("build-caster-width"),Gc=xe("build-battery-l"),Wc=xe("build-battery-w"),jc=xe("build-battery-h"),Xc=xe("build-powerbank-r"),qc=xe("build-powerbank-l");function Ul(){ie.isSupported&&ie.updateChassis({thickness:parseFloat(Oc.value)/1e3,bodyHalfWidth:parseFloat(Fc.value)/1e3,rearHalfWidth:parseFloat(kc.value)/1e3})}function Id(){ie.isSupported&&ie.updateWheel({radius:parseFloat(Bc.value)/1e3,width:parseFloat(zc.value)/1e3})}function Dd(){ie.isSupported&&ie.updateCaster(parseFloat(Hc.value)/1e3,parseFloat(Vc.value)/1e3)}function Ol(){ie.isSupported&&ie.updateBatteryBox(parseFloat(Gc.value)/1e3,parseFloat(Wc.value)/1e3,parseFloat(jc.value)/1e3)}function Ud(){ie.isSupported&&ie.updatePowerbank(parseFloat(Xc.value)/1e3,parseFloat(qc.value)/1e3)}const XE=[[Oc,"build-chassis-thickness-num",ns.thickness*1e3,Ul],[Fc,"build-chassis-body-hw-num",ns.bodyHalfWidth*1e3,Ul],[kc,"build-chassis-rear-hw-num",ns.rearHalfWidth*1e3,Ul],[Bc,"build-wheel-radius-num",Ti.radius*1e3,Id],[zc,"build-wheel-width-num",Ti.width*1e3,Id],[Hc,"build-caster-radius-num",0,Dd],[Vc,"build-caster-width-num",0,Dd],[Gc,"build-battery-l-num",0,Ol],[Wc,"build-battery-w-num",0,Ol],[jc,"build-battery-h-num",0,Ol],[Xc,"build-powerbank-r-num",0,Ud],[qc,"build-powerbank-l-num",0,Ud]];for(const[s,e,t,n]of XE){t>0&&(s.value=String(t));const i=xe(e);i.value=s.value,jE(s,i,n)}const Od=xe("build-export"),Yo=xe("build-copy-urdf"),Qf=xe("build-undo"),ep=xe("build-redo"),qE=xe("build-reset"),$E=xe("build-palette"),Qn=xe("build-components-list"),YE=xe("build-new-name"),KE=xe("build-new-create"),tp=xe("build-saved-toggle"),is=xe("build-saved-list"),np=xe("build-active-header"),JE=xe("build-active-name"),ip=xe("build-clear-custom"),ZE=xe("build-shortcuts-toggle"),Fd=xe("build-shortcuts"),sp=xe("lib-search"),kd=xe("lib-pills"),Bd=xe("lib-grid"),QE=xe("lib-no-build"),eM=xe("lib-empty"),tM=xe("build-comp-count"),nM=xe("build-comp-empty"),Fl=document.getElementById("chat-context-bar"),$c=document.getElementById("build-inspector"),iM=document.getElementById("build-inspector-title"),Os=document.getElementById("build-inspector-body"),sM=document.getElementById("build-inspector-close");function us(){const s=ie.chassisParams,e=ie.wheelParams,t=ie.powerbank,n=ie.batteryBox,i=[[Oc,"build-chassis-thickness-num",s.thickness*1e3],[Fc,"build-chassis-body-hw-num",s.bodyHalfWidth*1e3],[kc,"build-chassis-rear-hw-num",s.rearHalfWidth*1e3],[Bc,"build-wheel-radius-num",e.radius*1e3],[zc,"build-wheel-width-num",e.width*1e3],[Hc,"build-caster-radius-num",ie.casterRadius*1e3],[Vc,"build-caster-width-num",ie.casterWidth*1e3],[Gc,"build-battery-l-num",n.l*1e3],[Wc,"build-battery-w-num",n.w*1e3],[jc,"build-battery-h-num",n.h*1e3],[Xc,"build-powerbank-r-num",t.radius*1e3],[qc,"build-powerbank-l-num",t.length*1e3]];for(const[r,o,a]of i)r.value=String(a),xe(o).value=String(a);if(kt){const r=ie.getComponentEntries().find(o=>o.id===kt);r&&cp(kt,r.type)}Fr==null||Fr()}const Yc={chassis:{title:"Chassis",rows:[{label:"Thickness",unit:"mm",min:1,max:10,step:.5,get:()=>ie.chassisParams.thickness*1e3,set:s=>ie.updateChassis({...ie.chassisParams,thickness:s/1e3})},{label:"Body width",unit:"mm × 2",min:40,max:90,step:1,get:()=>ie.chassisParams.bodyHalfWidth*1e3,set:s=>ie.updateChassis({...ie.chassisParams,bodyHalfWidth:s/1e3})},{label:"Rear width",unit:"mm × 2",min:85,max:130,step:1,get:()=>ie.chassisParams.rearHalfWidth*1e3,set:s=>ie.updateChassis({...ie.chassisParams,rearHalfWidth:s/1e3})}]},wheels:{title:"Wheels",rows:[{label:"Radius",unit:"mm",min:20,max:50,step:.5,get:()=>ie.wheelParams.radius*1e3,set:s=>ie.updateWheel({...ie.wheelParams,radius:s/1e3})},{label:"Width",unit:"mm",min:8,max:30,step:1,get:()=>ie.wheelParams.width*1e3,set:s=>ie.updateWheel({...ie.wheelParams,width:s/1e3})}]},caster:{title:"Caster",rows:[{label:"Radius",unit:"mm",min:8,max:25,step:.5,get:()=>ie.casterRadius*1e3,set:s=>ie.updateCaster(s/1e3,ie.casterWidth)},{label:"Width",unit:"mm",min:5,max:25,step:.5,get:()=>ie.casterWidth*1e3,set:s=>ie.updateCaster(ie.casterRadius,s/1e3)}]},battery:{title:"Battery Box",rows:[{label:"Length",unit:"mm",min:40,max:120,step:1,get:()=>ie.batteryBox.l*1e3,set:s=>ie.updateBatteryBox(s/1e3,ie.batteryBox.w,ie.batteryBox.h)},{label:"Width",unit:"mm",min:25,max:80,step:1,get:()=>ie.batteryBox.w*1e3,set:s=>ie.updateBatteryBox(ie.batteryBox.l,s/1e3,ie.batteryBox.h)},{label:"Height",unit:"mm",min:15,max:50,step:1,get:()=>ie.batteryBox.h*1e3,set:s=>ie.updateBatteryBox(ie.batteryBox.l,ie.batteryBox.w,s/1e3)}]},powerbank:{title:"Power Bank",rows:[{label:"Radius",unit:"mm",min:8,max:25,step:.5,get:()=>ie.powerbank.radius*1e3,set:s=>ie.updatePowerbank(s/1e3,ie.powerbank.length)},{label:"Length",unit:"mm",min:50,max:200,step:1,get:()=>ie.powerbank.length*1e3,set:s=>ie.updatePowerbank(ie.powerbank.radius,s/1e3)}]}};let Fr=null,ta=null,$s=null;function kl(){const s=xe("float-panels");if(s.hasChildNodes()){if(ta&&$s){const e=Yc[$s];if(e){const t=e.rows.map((n,i)=>({label:n.label,unit:n.unit,from:ta[i],to:n.get()})).filter(n=>Math.abs(n.from-n.to)>=.01);t.length>0&&(cn==null||cn.appendRecapCard(e.title,t))}}s.innerHTML="",Fr=null,ta=null,$s=null,sn==null||sn.setParamCallback(null)}}function rp(s){kl();const e=xe("float-panels"),t=Yc[s];if(!t)return;const n=document.createElement("div");n.className="float-panel",n.dataset.panel=s,n.setAttribute("role","dialog"),n.setAttribute("aria-label",`${t.title} controls`);const i=document.createElement("div");i.className="float-panel-header";const r=document.createElement("div");r.className="float-panel-grip";for(let u=0;u<6;u++)r.appendChild(document.createElement("span"));const o=document.createElement("span");o.className="float-panel-title",o.textContent=t.title;const a=document.createElement("button");a.type="button",a.className="float-panel-close",a.setAttribute("aria-label","Close panel"),a.textContent="×",a.addEventListener("click",()=>kl()),i.append(r,o,a);const l=document.createElement("div");l.className="float-panel-body";const c=[];for(let u=0;u<t.rows.length;u++){const d=t.rows[u],f=document.createElement("div");f.className="float-panel-row",f.setAttribute("data-gesture-track",""),f.dataset.fpRowIndex=String(u);const g=document.createElement("div");g.className="float-panel-row-head";const _=document.createElement("span");_.className="float-panel-row-label",_.textContent=d.label;const p=document.createElement("span");p.className="float-panel-row-unit",p.textContent=d.unit,g.append(_,p);const m=document.createElement("div");m.className="float-panel-row-inputs";const w=document.createElement("input");w.type="range",w.min=String(d.min),w.max=String(d.max),w.step=String(d.step),w.value=String(d.get());const v=document.createElement("input");v.type="number",v.min=String(d.min),v.max=String(d.max),v.step=String(d.step),v.value=String(d.get());const S=I=>{d.set(I),us()};w.addEventListener("input",()=>{v.value=w.value,S(parseFloat(w.value))}),v.addEventListener("change",()=>{w.value=v.value,S(parseFloat(v.value))}),c.push(I=>{w.value=String(I),v.value=String(I)}),m.append(w,v),f.append(g,m),l.appendChild(f)}Fr=()=>t.rows.forEach((u,d)=>c[d](u.get())),ta=t.rows.map(u=>u.get()),$s=s;const h=op();n.append(i,l),e.appendChild(n),n.style.top=`${h}px`,ap(n,i),n.addEventListener("keydown",u=>{u.key==="Escape"&&kl()})}function op(){let s=60;return document.querySelectorAll(".float-panel").forEach(e=>{const t=e.getBoundingClientRect();t.width>0&&(s=Math.max(s,t.bottom+8))}),s}function ap(s,e){e.addEventListener("pointerdown",t=>{if(t.target.closest(".float-panel-close"))return;e.setPointerCapture(t.pointerId);const n=s.getBoundingClientRect(),i=t.clientX-n.left,r=t.clientY-n.top,o=a=>{s.style.left=`${a.clientX-i}px`,s.style.top=`${a.clientY-r}px`};e.addEventListener("pointermove",o),e.addEventListener("pointerup",()=>e.removeEventListener("pointermove",o),{once:!0})})}function rM(){const s=xe("gesture-hint-host");if(!s||s.querySelector(".float-panel"))return;const e=[{icon:"✊",html:"<strong>Fist + move</strong> — orbit camera"},{icon:"☝️",html:"<strong>Point + dwell 0.8 s</strong> — select joint"},{icon:"🤚",html:"<strong>Tilt wrist</strong> (joint selected) — rotate joint"},{icon:"🖐️",html:"<strong>Open palm, hold 1 s</strong> — reset all joints"},{icon:"🤲",html:"<strong>Two hands pinch/spread</strong> — zoom"},{icon:"👍",html:"<strong>Thumbs up</strong> — confirm / Continue"}],t=document.createElement("div");t.className="float-panel";const n=document.createElement("div");n.className="float-panel-header";const i=document.createElement("div");i.className="float-panel-grip";for(let c=0;c<6;c++)i.appendChild(document.createElement("span"));const r=document.createElement("span");r.className="float-panel-title",r.textContent="Gestures";const o=document.createElement("button");o.type="button",o.className="float-panel-close",o.setAttribute("aria-label","Close gesture hint"),o.textContent="×",o.addEventListener("click",()=>{s.innerHTML=""}),n.append(i,r,o);const a=document.createElement("div");a.className="float-panel-body",a.style.gap="7px";for(const c of e){const h=document.createElement("div");h.className="gesture-row";const u=document.createElement("span");u.className="gesture-icon",u.textContent=c.icon;const d=document.createElement("span");d.className="gesture-desc",d.innerHTML=c.html,h.append(u,d),a.appendChild(h)}const l=op();t.append(n,a),s.appendChild(t),t.style.top=`${l}px`,ap(t,n)}Qf.addEventListener("click",()=>ie.undo());ep.addEventListener("click",()=>ie.redo());qE.addEventListener("click",()=>{ie.isCatalogActive&&(ie.resetToDefaults(),us())});ie.onHistoryChange=()=>{Qf.disabled=!ie.canUndo,ep.disabled=!ie.canRedo};ie.onDOMRebuild=()=>{var e,t;const s=kt;to();for(const{id:n,type:i}of ie.getComponentEntries())ds(n,i),((e=Un[i])==null?void 0:e.geomType)==="mesh"&&_p(n,i);us(),On(),(t=ie.onHistoryChange)==null||t.call(ie),cn==null||cn.syncToolCount(),s&&ie.getComponentData(s)&&La(s)};sM.addEventListener("click",()=>cs());document.addEventListener("keydown",s=>{if(ie.isActive){if((s.ctrlKey||s.metaKey)&&s.key==="z"&&!s.shiftKey&&(s.preventDefault(),ie.undo()),(s.ctrlKey||s.metaKey)&&(s.key==="y"||s.key==="z"&&s.shiftKey)&&(s.preventDefault(),ie.redo()),kt&&(s.key==="Delete"||s.key==="Backspace")&&!s.ctrlKey&&!s.metaKey){const e=document.activeElement;if(e.tagName==="INPUT"||e.tagName==="TEXTAREA"||e.isContentEditable)return;s.preventDefault();const t=kt,n=Qn.querySelector(`[data-id="${t}"]`);ie.removeComponent(t),cs(),Kc(t),n==null||n.remove(),On();return}if(s.key==="Escape"&&kt){const e=document.activeElement;if(e.tagName==="INPUT"||e.tagName==="TEXTAREA")return;cs();return}if(kt&&["ArrowLeft","ArrowRight","ArrowUp","ArrowDown"].includes(s.key)&&!s.ctrlKey&&!s.metaKey){s.preventDefault();const e=ie.getComponentData(kt);if(!e)return;const t=.001;let{x:n,y:i,z:r}=e;s.shiftKey?(s.key==="ArrowUp"&&(r+=t),s.key==="ArrowDown"&&(r-=t)):(s.key==="ArrowLeft"&&(i+=t),s.key==="ArrowRight"&&(i-=t),s.key==="ArrowUp"&&(n-=t),s.key==="ArrowDown"&&(n+=t)),ie.updateComponent(kt,{x:n,y:i,z:r});const o=ir.get(kt);o&&(o.x.value=n.toFixed(4),o.y.value=i.toFixed(4),o.z.value=r.toFixed(4))}}});Od.addEventListener("click",()=>void ie.exportZip(Od));Yo.addEventListener("click",()=>{const s=ie.getURDFXML();navigator.clipboard.writeText(s).then(()=>{const e=Yo.textContent;Yo.textContent="Copied!",setTimeout(()=>{Yo.textContent=e},1500)}).catch(()=>{})});KE.addEventListener("click",()=>{to(),ie.initFromScratch(YE.value),ie.open(),xe("tab-build").click(),eo(),nr(),On()});function eo(){const s=Sa.savedCustomNames();if(tp.hidden=s.length===0,s.length===0){is.hidden=!0;return}is.innerHTML="";for(const e of s){const t=document.createElement("div");t.className="build-saved-row";const n=document.createElement("span");n.className="build-saved-name",n.textContent=e;const i=document.createElement("button");i.type="button",i.className="build-export-btn build-saved-load",i.textContent="Load",i.addEventListener("click",()=>{to();const o=ie.restoreCustomByName(e);for(const{id:a,type:l}of o)ds(a,l);o.length>0&&us(),On(),ie.open(),xe("tab-build").click(),nr(),is.hidden=!0});const r=document.createElement("button");r.type="button",r.className="build-remove-btn",r.textContent="×",r.title="Delete saved robot",r.addEventListener("click",()=>{ie.deleteCustom(e),ie.robotName===e&&nr(),eo()}),t.append(n,i,r),is.appendChild(t)}}function nr(){const s=ie.isCatalogActive;np.hidden=!s,s&&(JE.textContent=ie.robotName,ip.hidden=ie.isSupported)}tp.addEventListener("click",()=>{is.hidden=!is.hidden});ip.addEventListener("click",()=>{ie.deleteCustom(ie.robotName),np.hidden=!0,is.hidden=!0,eo()});ZE.addEventListener("click",s=>{s.stopPropagation(),Fd.hidden=!Fd.hidden});eo();nr();const lp=new Map;function On(){const s=new Map,e=ie.getComponentEntries();for(const{type:n}of e)s.set(n,(s.get(n)??0)+1);for(const[n,i]of lp){const r=s.get(n)??0;i.textContent=r>0?String(r):"",i.style.display=r>0?"inline":"none"}const t=e.length;tM.textContent=t>0?`${t} added`:"",nM.hidden=t>0||!ie.isCatalogActive}for(const[s,e]of Object.entries(Un)){if(e.geomType==="mesh"||e.hidden)continue;const t=document.createElement("button");t.type="button",t.className="robot-btn",t.style.cssText="position: relative;",t.textContent=e.label,t.dataset.comp=s;const n=document.createElement("span");n.style.cssText="position:absolute;top:2px;right:3px;font-size:9px;line-height:1;color:var(--blue);display:none;font-weight:700;",t.appendChild(n),lp.set(s,n),t.addEventListener("click",()=>{var r;if(!ie.isCatalogActive)return;const i=ie.addComponent(s);Ra(i),ds(i,s),On(),(r=Qn.querySelector(`[data-id="${i}"]`))==null||r.scrollIntoView({behavior:"smooth",block:"nearest"})}),$E.appendChild(t)}const ir=new Map,sr=new Map;let kt=null,Ii=null;function to(){Qn.innerHTML="",cs()}function cs(){kt=null,Ii=null;for(const s of Qn.querySelectorAll(".build-component"))s.classList.remove("selected");$c.hidden=!0,Os.innerHTML="",ir.clear(),sr.clear(),ua(null)}function ua(s){if(Fl.innerHTML="",Fl.hidden=!s,!s)return;const e=document.createElement("span");e.className="context-pill";const t=document.createElement("span");t.className="context-pill-dot",t.style.background=s.color;const n=document.createElement("span");n.textContent=s.label;const i=document.createElement("button");i.type="button",i.className="context-pill-dismiss",i.textContent="×",i.title="Deselect",i.addEventListener("click",s.onDismiss),e.append(t,n,i),Fl.appendChild(e)}function Ra(s){for(const[e,t]of sr)if(e!==s&&!Array.from(t.options).some(n=>n.value===s)){const n=document.createElement("option");n.value=n.textContent=s,t.appendChild(n)}}function Kc(s){for(const e of sr.values()){const t=Array.from(e.options).find(n=>n.value===s);t&&e.removeChild(t)}}function La(s){kt=s,Ii=null;for(const n of Qn.querySelectorAll(".build-component"))n.classList.toggle("selected",n.dataset.id===s);const e=ie.getComponentEntries().find(n=>n.id===s);e&&cp(s,e.type);const t=Un[(e==null?void 0:e.type)??""];ua({label:`${(t==null?void 0:t.label)??(e==null?void 0:e.type)??s} · ${s}`,color:(t==null?void 0:t.cssColor)??"#888",onDismiss:cs})}function ds(s,e,t){const n=Un[e],i=document.createElement("div");i.className="build-component",i.dataset.id=s;const r=document.createElement("div");r.className="build-component-header";const o=document.createElement("span");o.style.cssText=`width:7px;height:7px;border-radius:50%;flex-shrink:0;background:${(n==null?void 0:n.cssColor)??"#888"}`;const a=document.createElement("span");a.textContent=`${n.label} ${s.split("_").pop()}`;const l=document.createElement("button");l.type="button",l.className="build-remove-btn",l.title="Duplicate",l.textContent="⧉",l.addEventListener("click",h=>{var d;h.stopPropagation();const u=ie.duplicateComponent(s);u&&(Ra(u),ds(u,e),((d=Un[e])==null?void 0:d.geomType)==="mesh"&&_p(u,e),On())});const c=document.createElement("button");c.type="button",c.className="build-remove-btn",c.title="Remove",c.textContent="×",c.addEventListener("click",h=>{h.stopPropagation(),ie.removeComponent(s),kt===s&&cs(),Kc(s),i.remove(),On()}),r.addEventListener("click",()=>La(s)),r.append(o,a,l,c),i.appendChild(r),Qn.appendChild(i)}function cp(s,e){var v,S;const t=ie.getComponentData(s);if(!t)return;const n=Un[e];Os.innerHTML="",ir.delete(s),sr.delete(s);const i={},r={};function o(){var C,D,E,y,U,z,F;const I=n.geomType==="cylinder"?[parseFloat(i.r.value)||.001,parseFloat(i.l.value)||.001]:[parseFloat(i.w.value)||.001,parseFloat(i.d.value)||.001,parseFloat(i.h.value)||.001],P=((C=r.jt)==null?void 0:C.value)??"fixed";ie.updateComponent(s,{x:parseFloat(i.x.value)||0,y:parseFloat(i.y.value)||0,z:parseFloat(i.z.value)||0,rx:parseFloat(i.rx.value)||0,ry:parseFloat(i.ry.value)||0,rz:parseFloat(i.rz.value)||0,dims:I,jointType:P,axis:[parseFloat((D=i.ax)==null?void 0:D.value)||0,parseFloat((E=i.ay)==null?void 0:E.value)||0,parseFloat((y=i.az)==null?void 0:y.value)||1],limitLower:parseFloat((U=i.limitMin)==null?void 0:U.value)||-1.5708,limitUpper:parseFloat((z=i.limitMax)==null?void 0:z.value)||1.5708,parent:((F=r.parent)==null?void 0:F.value)??"base_link"})}function a(I,P,C,D,E,y=Os){const U=document.createElement("div");U.className="inspector-row";const z=document.createElement("label");z.className=P,z.textContent=C;const F=document.createElement("input");F.type="number",F.step=String(D),F.value=String(E),F.addEventListener("input",o),Zf(z,F),i[I]=F,U.append(z,F),y.appendChild(U)}function l(I,P=Os){const C=document.createElement("div");C.className="build-group-label",C.textContent=I,P.appendChild(C)}function c(I,P,C,D=Os){const E=document.createElement("div");E.className="inspector-row";const y=document.createElement("label");y.textContent=P;const U=document.createElement("select");U.className="build-select";for(const z of C){const F=document.createElement("option");F.value=F.textContent=z,U.appendChild(F)}U.addEventListener("change",o),r[I]=U,E.append(y,U),D.appendChild(E)}l("Position"),a("x","axis-x","X",.005,t.x??0),a("y","axis-y","Y",.005,t.y??0),a("z","axis-z","Z",.005,t.z??n.defaultZ),l("Size"),n.geomType==="cylinder"?(a("r","axis-x","R",.005,t.dims[0]??n.defaultDims[0]),a("l","axis-z","L",.005,t.dims[1]??n.defaultDims[1])):(a("w","axis-x","W",.005,t.dims[0]??n.defaultDims[0]),a("d","axis-y","D",.005,t.dims[1]??n.defaultDims[1]),a("h","axis-z","H",.005,t.dims[2]??n.defaultDims[2]));const h=t.jointType??"fixed",u=h==="revolute"||h==="prismatic",d=document.createElement("details");d.className="build-comp-advanced",h!=="fixed"&&(d.open=!0);const f=document.createElement("summary");f.textContent="Rotation · Joint · Limits",d.appendChild(f),Os.appendChild(d),l("Rotation",d),a("rx","axis-x","Rx",.01,t.rx??0,d),a("ry","axis-y","Ry",.01,t.ry??0,d),a("rz","axis-z","Rz",.01,t.rz??0,d),l("Joint",d),c("parent","Parent",ie.getAvailableLinks().filter(I=>I!==s),d),c("jt","Type",["fixed","continuous","revolute","prismatic"],d),t.parent&&r.parent&&(r.parent.value=t.parent),t.jointType&&r.jt&&(r.jt.value=t.jointType);const g=document.createElement("div");l("Axis",g),a("ax","axis-x","X",.1,t.axis[0]??0,g),a("ay","axis-y","Y",.1,t.axis[1]??0,g),a("az","axis-z","Z",.1,t.axis[2]??1,g),g.hidden=h==="fixed",d.appendChild(g);const _=document.createElement("div");l("Limits",_),a("limitMin","axis-x","Min",.01,t.limitLower??-1.5708,_),a("limitMax","axis-z","Max",.01,t.limitUpper??1.5708,_),_.hidden=!u,d.appendChild(_);const p=document.createElement("div"),m=document.createElement("input");m.type="range",m.step="0.01",m.min=String(t.limitLower??-1.5708),m.max=String(t.limitUpper??1.5708),m.value="0",m.dataset.preview="true",m.style.cssText="width: 100%; margin-top: 2px;",m.addEventListener("input",()=>{var I;(I=Ue.robot)==null||I.setJointValue(`${s}_joint`,parseFloat(m.value))}),(v=i.limitMin)==null||v.addEventListener("input",()=>{m.min=i.limitMin.value}),(S=i.limitMax)==null||S.addEventListener("input",()=>{m.max=i.limitMax.value}),l("Preview",p);const w=document.createElement("div");w.className="build-preview-row",w.appendChild(m),p.appendChild(w),p.hidden=!u,d.appendChild(p),r.jt.addEventListener("change",()=>{var C;const I=r.jt.value,P=I==="revolute"||I==="prismatic";g.hidden=I==="fixed",_.hidden=!P,p.hidden=!P,I!=="fixed"&&!d.open&&(d.open=!0),P||(m.value="0",(C=Ue.robot)==null||C.setJointValue(`${s}_joint`,0))}),ir.set(s,i),r.parent&&sr.set(s,r.parent),iM.textContent=`${n.label} · ${s}`,$c.hidden=!1}function oM(s){const e=Qn.querySelector(`[data-id="${s}"]`);ir.delete(s),sr.delete(s),Kc(s),kt===s&&cs(),e==null||e.remove()}document.querySelectorAll(".build-section-detach").forEach(s=>{s.addEventListener("click",e=>{var n;e.preventDefault(),e.stopPropagation();const t=((n=s.closest("[data-panel]"))==null?void 0:n.dataset.panel)??"";rp(t)})});{const s={isEditorTabActive:()=>document.body.classList.contains("editor-open"),handleEditorInput:e=>fn.handleExternalInput(e),onComponentAdded:(e,t)=>{Ra(e),ds(e,t)},onComponentRemoved:e=>oM(e),syncSlidersFromController:us,switchToBuildTab:()=>xe("tab-build").click(),onBriefToggle:e=>{fn.brief=e},refreshPaletteCounts:On,getPartsList:()=>fn.partsList,readPart:e=>fn.readPart(e),updatePart:(e,t)=>fn.writePart(e,t),highlightPart:e=>Qr(e),getJointNames:()=>{var e;return Object.keys(((e=Ue.robot)==null?void 0:e.joints)??{})},initRobot:(e,t)=>{to(),ie.initFromScratch(e==="robot-car"?"Robot Car":t??"My Robot"),e==="robot-car"&&["03-wheels.xml","04-caster.xml","06-power.xml"].forEach(n=>{fetch(`/robots/robot-car/parts/${n}`).then(i=>i.ok?i.text():null).then(i=>{i&&ie.setPartTemplate(n,i)}).catch(()=>{})}),ie.open(),eo(),nr(),On(),xe("tab-build").click(),cn==null||cn.syncToolCount()},getFocusedComponent:()=>{var e;if(kt){const t=ie.getComponentEntries().find(n=>n.id===kt);return t?{id:kt,type:t.type,data:ie.getComponentData(kt)}:null}if(Ii){const t=(e=Ue.robot)==null?void 0:e.joints[Ii];if(!t)return null;const n=t.position,i=t.jointType??"fixed";return{id:Ii,type:i,data:{type:i,x:n.x,y:n.y,z:n.z,rx:0,ry:0,rz:0,dims:[],jointType:i,axis:[0,0,1],limitLower:0,limitUpper:0,parent:"base_link"}}}return null},openPanel:e=>rp(e),openGestureHint:()=>rM(),isGestureActive:()=>sn!==null};cn=new TE(ie,s),cn.init()}const pi=new Rc,Pa=new ye,sc=new Ln,rc=new Ln,oc=new k,hp=new k,wr=new k;let Di=null,Rn=null,up=0,dp=0,fp=0,Hs=0,Vs=0,Gs=0,pp=0,mp=0;function Jc(s){const e=Ue.renderer.domElement.getBoundingClientRect();Pa.set((s.clientX-e.left)/e.width*2-1,-((s.clientY-e.top)/e.height)*2+1)}function gp(s){const e=ie.componentIds;let t=s;for(;t;){if(t.isURDFLink&&t.urdfName&&e.has(t.urdfName))return t.urdfName;t=t.parent}return null}Ue.renderer.domElement.addEventListener("pointerdown",s=>{if(!ie.isCatalogActive)return;Jc(s),pi.setFromCamera(Pa,Ue.camera);const e=pi.intersectObject(Ue.scene,!0);if(!e.length)return;const t=gp(e[0].object);if(!t||!ie.isFixedComponent(t))return;const n=ie.getComponentXYZ(t);if(!n)return;sc.set(new k(0,1,0),-n.z),pi.ray.intersectPlane(sc,oc);const i=new k;Ue.camera.getWorldDirection(i),i.y=0,i.normalize(),rc.setFromNormalAndCoplanarPoint(i,new k(n.x,n.z,-n.y)),pi.ray.intersectPlane(rc,hp),Di=t,up=n.x,dp=n.y,fp=n.z,Hs=n.z,Vs=n.x,Gs=n.y,ie.startComponentDrag(t),Ue.controls.enabled=!1,pp=s.clientX,mp=s.clientY,Rn=Qn.querySelector(`[data-id="${t}"]`),Rn==null||Rn.classList.add("dragging"),La(t),Ue.renderer.domElement.setPointerCapture(s.pointerId),s.stopPropagation()});Ue.renderer.domElement.addEventListener("pointermove",s=>{var i;if(!Di)return;Jc(s),pi.setFromCamera(Pa,Ue.camera);const e=(i=Ue.robot)==null?void 0:i.joints[`${Di}_joint`],t=ir.get(Di),n=.001;if(Ue.renderer.domElement.style.cursor=s.shiftKey?"ns-resize":"grabbing",s.shiftKey){if(!pi.ray.intersectPlane(rc,wr))return;Hs=Math.round((fp+(wr.y-hp.y))/n)*n,e&&e.position.set(Vs,Gs,Hs),t&&(t.z.value=Hs.toFixed(4))}else{if(!pi.ray.intersectPlane(sc,wr))return;Vs=Math.round((up+(wr.x-oc.x))/n)*n,Gs=Math.round((dp-(wr.z-oc.z))/n)*n,e&&e.position.set(Vs,Gs,Hs),t&&(t.x.value=Vs.toFixed(4),t.y.value=Gs.toFixed(4))}});Ue.renderer.domElement.addEventListener("pointerup",s=>{if(!Di)return;const e=Math.hypot(s.clientX-pp,s.clientY-mp)>8;if(ie.finishComponentDrag(Di,Vs,Gs,Hs),Ue.controls.enabled=!0,Ue.renderer.domElement.style.cursor="",Rn==null||Rn.classList.remove("dragging"),!e&&Rn){const t=Rn.dataset.id;t&&La(t),Rn.scrollIntoView({behavior:"smooth",block:"nearest"})}Rn=null,Di=null});const Zi=xe("build-hover-tip");let zd=0;Ue.renderer.domElement.addEventListener("pointermove",s=>{if(!ie.isCatalogActive||Di){Zi.style.display="none";return}cancelAnimationFrame(zd),zd=requestAnimationFrame(()=>{var n;Jc(s),pi.setFromCamera(Pa,Ue.camera);const e=pi.intersectObject(Ue.scene,!0),t=e.length?gp(e[0].object):null;if(t){const i=Un[((n=ie.getComponentData(t))==null?void 0:n.type)??""];Zi.textContent=i?`${i.label} #${t.split("_").pop()}`:t,Zi.style.display="block",Zi.style.left=s.clientX+12+"px",Zi.style.top=s.clientY-28+"px"}else Zi.style.display="none"})});Ue.renderer.domElement.addEventListener("pointerleave",()=>{Zi.style.display="none"});function _p(s,e){const t=Ri.find(n=>n.id===e);t&&t.factory().then(({generate:n})=>ie.restoreMeshBlob(s,n())).catch(n=>console.warn("[regenMeshBlob] failed for",s,n))}const aM={Sensor:"📡",Actuator:"⚙️",MCU:"💾",Power:"🔋",Structural:"🧱"};let ac="";function Zc(){const s=ie.isCatalogActive,e=sp.value.trim().toLowerCase();QE.hidden=s;const t=Ri.filter(n=>!(ac&&n.category!==ac||e&&!n.label.toLowerCase().includes(e)&&!n.description.toLowerCase().includes(e)));Bd.innerHTML="",eM.hidden=t.length>0;for(const n of t)Bd.appendChild(lM(n,s))}function lM(s,e){const t=document.createElement("div");t.className="lib-card";const n=document.createElement("div");n.className="lib-thumb",n.style.background=s.cssColor+"33",n.style.borderBottom=`2px solid ${s.cssColor}`,n.textContent=aM[s.category]??"📦";const i=document.createElement("div");i.className="lib-card-info";const r=document.createElement("div");r.className="lib-card-name",r.textContent=s.label,r.title=s.description;const o=document.createElement("div");o.className="lib-card-meta";const a=Object.assign(document.createElement("span"),{className:"lib-card-cat",textContent:s.category}),l=s.defaultDims.map(u=>Math.round(u*1e3)).join("×")+" mm",c=Object.assign(document.createElement("span"),{className:"lib-card-dims",textContent:l});o.append(a,c);const h=document.createElement("button");return h.type="button",h.className="lib-card-add",h.textContent="Add to Build",h.disabled=!e,h.addEventListener("click",()=>void cM(s,h)),i.append(r,o,h),t.append(n,i),t}async function cM(s,e){var n;if(!ie.isCatalogActive)return;const t=e.textContent??"Add to Build";e.disabled=!0,e.textContent="Generating…";try{const{generate:i}=await s.factory(),r=i(),o=ie.addMeshComponent(s.id,r);Ra(o),ds(o,s.id),On(),xe("tab-build").click(),(n=Qn.querySelector(`[data-id="${o}"]`))==null||n.scrollIntoView({behavior:"smooth",block:"nearest"})}catch(i){console.error("[Library] generate failed:",i),e.textContent="Error",setTimeout(()=>{e.textContent=t,e.disabled=!ie.isCatalogActive},2e3);return}e.textContent=t,e.disabled=!1}sp.addEventListener("input",Zc);"serviceWorker"in navigator&&navigator.serviceWorker.register("/sw.js").catch(()=>{});for(const s of kd.querySelectorAll(".lib-pill"))s.addEventListener("click",()=>{for(const e of kd.querySelectorAll(".lib-pill"))e.classList.remove("lib-pill--active");s.classList.add("lib-pill--active"),ac=s.dataset.cat??"",Zc()});export{or as B,xc as C,Rc as R,Zu as S,k as V,ye as a,yE as g,hM as m};
