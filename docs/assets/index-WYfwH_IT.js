...
${a.length>0?"• The robot is already assembled. Tour the EXISTING parts one by one — use read_part to examine each file, explain what the component is and why it sits where it does. Do NOT call add_component for parts that already exist as URDF files.":"• The robot has no parts yet. Guide the user through building from scratch — add one component at a time and explain what it is and why it goes there before placing it."}
