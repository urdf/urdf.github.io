...
BRIEF MODE: Answer in fewer than 4 lines. No preamble. Direct answers only. Emoji allowed as semantic shorthand when it replaces a word more efficiently than text.`:"",d=!this._buildCtrl.isCatalogActive&&a.length===0?`The workspace is empty. Ask the user what they want to build, then call init_robot with their choice:
...
Available library components: ${wi.map(g=>g.id).join(", ")}${o}${l}
