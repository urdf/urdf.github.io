...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Ai,depthTest:!1,depthWrite:!1})}function Jh(){return new Di({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:tc(),fragmentShader:`
		...
		`,blending:Ai,depthTest:!1,depthWrite:!1})}function Qh(){return new Di({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:tc(),fragmentShader:`
...
`)}function Zb(s){const e=s.getAttribute("position"),t=s.getIndex(),n=[];for(let l=0;l<e.count;l++)n.push([e.getX(l),e.getY(l),e.getZ(l)]);const i=[];if(t)for(let l=0;l<t.count;l+=3)i.push([t.getX(l),t.getX(l+1),t.getX(l+2)]);else for(let l=0;l<e.count;l+=3)i.push([l,l+1,l+2]);const r=new ArrayBuffer(84+i.length*50),o=new DataView(r);o.setUint32(80,i.length,!0);let a=84;for(const[l,c,h]of i){const u=n[l],d=n[c],f=n[h],g=d[0]-u[0],_=d[1]-u[1],p=d[2]-u[2],m=f[0]-u[0],T=f[1]-u[1],b=f[2]-u[2],E=_*b-p*T,I=p*m-g*b,P=g*T-_*m,C=Math.sqrt(E*E+I*I+P*P)||1;o.setFloat32(a,E/C,!0),a+=4,o.setFloat32(a,I/C,!0),a+=4,o.setFloat32(a,P/C,!0),a+=4;for(const D of[u,d,f])o.setFloat32(a,D[0],!0),a+=4,o.setFloat32(a,D[1],!0),a+=4,o.setFloat32(a,D[2],!0),a+=4;o.setUint16(a,0,!0),a+=2}return r}const Qi={thickness:.003,bodyHalfWidth:.062,rearHalfWidth:.095};function xl(s){const e=Math.max(.001,Math.min(.01,s.thickness)),t=Math.max(.04,Math.min(.09,s.bodyHalfWidth)),n=Math.max(t+.01,Math.min(.13,s.rearHalfWidth)),i=.115,r=.01,o=.08,a=-.145,l=t;function c(T,b,E,I,P=8e-4){const C=new Rr;return C.moveTo(T-E/2+P,b-I/2),C.lineTo(T+E/2-P,b-I/2),C.quadraticCurveTo(T+E/2,b-I/2,T+E/2,b-I/2+P),C.lineTo(T+E/2,b+I/2-P),C.quadraticCurveTo(T+E/2,b+I/2,T+E/2-P,b+I/2),C.lineTo(T-E/2+P,b+I/2),C.quadraticCurveTo(T-E/2,b+I/2,T-E/2,b+I/2-P),C.lineTo(T-E/2,b-I/2+P),C.quadraticCurveTo(T-E/2,b-I/2,T-E/2+P,b-I/2),C}function h(T,b,E){const I=new Rr;return I.absarc(T,b,E,0,Math.PI*2,!1),I}const u=new df;u.moveTo(-n+r,i),u.lineTo(n-r,i),u.quadraticCurveTo(n,i,n,i-r),u.lineTo(n,o),u.lineTo(t,o),u.lineTo(t,a+l),u.absarc(0,a+l,t,0,-Math.PI,!0),u.lineTo(-t,o),u.lineTo(-n,o),u.lineTo(-n,i-r),u.quadraticCurveTo(-n,i,-n+r,i);const d=n-.02;u.holes.push(c(-d,.093,.012,.014,.001)),u.holes.push(c(d,.093,.012,.014,.001));const f=new Rr,g=0,_=.05;f.moveTo(g-.025,_-.035),f.lineTo(g-.025,_-.018),f.lineTo(g-.033,_-.018),f.lineTo(g-.033,_+.002),f.lineTo(g-.025,_+.002),f.lineTo(g-.025,_+.018),f.lineTo(g-.015,_+.028),f.lineTo(g+.015,_+.028),f.lineTo(g+.025,_+.018),f.lineTo(g+.025,_+.002),f.lineTo(g+.033,_+.002),f.lineTo(g+.033,_-.018),f.lineTo(g+.025,_-.018),f.lineTo(g+.025,_-.035),f.lineTo(g-.025,_-.035),u.holes.push(f),u.holes.push(c(-.025,.098,.018,.006,.001)),u.holes.push(c(.025,.098,.018,.006,.001)),u.holes.push(c(0,.09,.014,.004,.001)),u.holes.push(c(-.025,-.085,.018,.004,.001)),u.holes.push(c(.025,-.085,.018,.004,.001)),u.holes.push(h(0,-.098,.006));const p=.002;u.holes.push(h(-.08,.105,p)),u.holes.push(h(.08,.105,p)),u.holes.push(h(-.08,.083,p)),u.holes.push(h(.08,.083,p)),u.holes.push(h(-.02,.108,p)),u.holes.push(h(.02,.108,p)),u.holes.push(h(-.048,.01,p)),u.holes.push(h(.048,.01,p)),u.holes.push(h(-.048,-.03,p)),u.holes.push(h(.048,-.03,p)),u.holes.push(h(0,-.02,p)),u.holes.push(h(-.014,-.065,p)),u.holes.push(h(.014,-.065,p)),u.holes.push(h(-.014,-.052,p)),u.holes.push(h(.014,-.052,p)),u.holes.push(h(-.04,-.062,p)),u.holes.push(h(.04,-.062,p));const m=new cc(u,{depth:e,bevelEnabled:!1,curveSegments:48});return m.rotateZ(-Math.PI/2),Zb(m)}const Ji={radius:.0325,width:.026};function bl(s){const e=Math.max(.02,Math.min(.05,s.radius)),t=e*(31/32.5),n=Math.max(.008,Math.min(.03,s.width)),i=64,r=16,o=4,a=.58,l=.62,c=[],h=(T,b,E)=>c.push(...T,...b,...E),u=(T,b,E,I)=>{h(T,b,E),h(T,E,I)};for(let T=0;T<i;T++){const b=2*Math.PI*T/i,E=2*Math.PI*(T+1)/i,I=Math.cos(b),P=Math.sin(b),C=Math.cos(E),D=Math.sin(E),M=[t*I,t*P,-n/2],y=[t*C,t*D,-n/2],U=[t*I,t*P,n/2],z=[t*C,t*D,n/2];u(M,y,z,U),h([0,0,-n/2],y,M),h([0,0,n/2],U,z)}const d=2*Math.PI/r,f=n/o;for(let T=0;T<r;T++){const b=d*(T+.5),E=b-d*a/2,I=b+d*a/2;for(let P=0;P<o;P++){const C=-n/2+f*(P+.5),D=C-f*l/2,M=C+f*l/2,[y,U,z,F]=[Math.cos(E),Math.sin(E),Math.cos(I),Math.sin(I)],H=[t*y,t*U,D],J=[t*z,t*F,D],B=[t*y,t*U,M],ce=[t*z,t*F,M],G=[e*y,e*U,D],ie=[e*z,e*F,D],oe=[e*y,e*U,M],pe=[e*z,e*F,M];u(G,ie,pe,oe),u(H,G,oe,B),u(J,ce,pe,ie),u(H,J,ie,G),u(oe,pe,ce,B)}}const g=c.length/9,_=new ArrayBuffer(84+g*50),p=new DataView(_);p.setUint32(80,g,!0);let m=84;for(let T=0;T<g;T++){const b=T*9,E=c[b+3]-c[b],I=c[b+4]-c[b+1],P=c[b+5]-c[b+2],C=c[b+6]-c[b],D=c[b+7]-c[b+1],M=c[b+8]-c[b+2],y=I*M-P*D,U=P*C-E*M,z=E*D-I*C,F=Math.sqrt(y*y+U*U+z*z)||1;p.setFloat32(m,y/F,!0),m+=4,p.setFloat32(m,U/F,!0),m+=4,p.setFloat32(m,z/F,!0),m+=4;for(let H=0;H<9;H++)p.setFloat32(m,c[b+H],!0),m+=4;p.setUint16(m,0,!0),m+=2}return _}const wi=[{id:"hcsr04",label:"HC-SR04",category:"Sensor",description:"Ultrasonic distance sensor",defaultDims:[.045,.02,.015],cssColor:"#3373e5",urdfRgba:"0.20 0.45 0.90 1.00",defaultZ:.015,factory:()=>oi(()=>import("./generators-CsNZlX3_.js"),[]).then(s=>({generate:s.generateHcsr04}))},{id:"l298n",label:"L298N",category:"Actuator",description:"Dual H-bridge motor driver",defaultDims:[.043,.043,.02],cssColor:"#c01f1f",urdfRgba:"0.75 0.12 0.12 1.00",defaultZ:.005,factory:()=>oi(()=>import("./generators-CsNZlX3_.js"),[]).then(s=>({generate:s.generateL298n}))},{id:"esp32cam_lib",label:"ESP32-CAM",category:"MCU",description:"ESP32 camera module",defaultDims:[.0405,.027,.013],cssColor:"#1a7a3c",urdfRgba:"0.00 0.45 0.20 1.00",defaultZ:.005,factory:()=>oi(()=>import("./generators-CsNZlX3_.js"),[]).then(s=>({generate:s.generateEsp32Cam}))},{id:"tt_motor",label:"TT Motor",category:"Actuator",description:"TT gear motor with DC can",defaultDims:[.036,.018,.022],cssColor:"#c89a14",urdfRgba:"0.83 0.63 0.09 1.00",defaultZ:.011,factory:()=>oi(()=>import("./generators-CsNZlX3_.js"),[]).then(s=>({generate:s.generateTtMotor}))},{id:"sg90",label:"SG90",category:"Actuator",description:"Micro servo motor",defaultDims:[.022,.0115,.023],cssColor:"#e07810",urdfRgba:"0.90 0.50 0.15 1.00",defaultZ:.012,factory:()=>oi(()=>import("./generators-CsNZlX3_.js"),[]).then(s=>({generate:s.generateSg90}))},{id:"arduino_nano",label:"Arduino Nano",category:"MCU",description:"Arduino Nano microcontroller",defaultDims:[.043,.018,.01],cssColor:"#006e33",urdfRgba:"0.00 0.50 0.30 1.00",defaultZ:.005,factory:()=>oi(()=>import("./generators-CsNZlX3_.js"),[]).then(s=>({generate:s.generateArduinoNano}))},{id:"mpu6050",label:"MPU-6050",category:"Sensor",description:"6-axis IMU (accelerometer + gyroscope)",defaultDims:[.02,.02,.0025],cssColor:"#7a52cc",urdfRgba:"0.55 0.35 0.80 1.00",defaultZ:.005,factory:()=>oi(()=>import("./generators-CsNZlX3_.js"),[]).then(s=>({generate:s.generateMpu6050}))}],Jb=Object.fromEntries(wi.map(s=>[s.id,{label:s.label,color:s.urdfRgba,defaultZ:s.defaultZ,geomType:"mesh",defaultDims:[...s.defaultDims],category:s.category,cssColor:s.cssColor}])),Nn={ultrasonic:{label:"Ultrasonic",color:"0.20 0.45 0.90 1.00",defaultZ:.015,geomType:"box",defaultDims:[.045,.02,.015],hidden:!0},camera:{label:"Camera",color:"0.90 0.20 0.25 1.00",defaultZ:.01,geomType:"box",defaultDims:[.025,.024,.009]},lidar:{label:"LIDAR",color:"0.20 0.80 0.45 1.00",defaultZ:.035,geomType:"cylinder",defaultDims:[.035,.04]},imu:{label:"IMU",color:"0.55 0.35 0.80 1.00",defaultZ:.008,geomType:"box",defaultDims:[.02,.02,.008],hidden:!0},servo:{label:"Servo",color:"0.90 0.50 0.15 1.00",defaultZ:.02,geomType:"box",defaultDims:[.022,.012,.03],hidden:!0},arduino:{label:"Arduino",color:"0.00 0.45 0.20 1.00",defaultZ:.008,geomType:"box",defaultDims:[.044,.018,.008],hidden:!0},raspberry_pi:{label:"Raspberry Pi",color:"0.70 0.10 0.20 1.00",defaultZ:.017,geomType:"box",defaultDims:[.086,.056,.017]},gps:{label:"GPS",color:"0.20 0.70 0.35 1.00",defaultZ:.01,geomType:"box",defaultDims:[.025,.025,.01]},buck_converter:{label:"Buck Conv.",color:"0.85 0.60 0.00 1.00",defaultZ:.011,geomType:"box",defaultDims:[.023,.017,.011]},box:{label:"Box",color:"0.65 0.65 0.65 1.00",defaultZ:.02,geomType:"box",defaultDims:[.04,.04,.02]},...Jb},Qb=new Set(["robot-car"]);function cd(s,e){const t=[...e.entries()].sort(([r],[o])=>r.localeCompare(o)),n=t.filter(([r])=>r.startsWith("00")).map(([,r])=>r.trimEnd()).join(`
...
BRIEF MODE: Answer in fewer than 4 lines. No preamble. Direct answers only. Emoji allowed as semantic shorthand when it replaces a word more efficiently than text.`:"",h=this._buildCtrl.isCatalogActive,u=this._cb.getJointNames(),d=u.length>0,g=!h&&!d?`The workspace is empty. Ask the user what they want to build, then call init_robot with their choice:
...
• "custom" — blank chassis to build anything. After init_robot, guide the user through adding components one by one.`:d?`The robot is loaded in the 3D viewer. Tour it joint by joint using the list below — highlight_part each one, explain what it is and why it's there. Do NOT call add_component; the robot is already built.${a.length>0?" Use read_part to examine URDF files for details.":""}`:"The robot has no parts yet. Guide the user through building from scratch — add one component at a time and explain what it is and why it goes there before placing it.";return`${this._guide?`GUIDE MODE: You are an interactive assembly guide. Rules:
...
• ${g}
${u.length>0?`Available joints to highlight: ${u.join(", ")}`:""}
...
Available library components: ${wi.map(p=>p.id).join(", ")}${o}${l}
